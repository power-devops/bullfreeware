...
if [ $? -eq 0 ]
then
	echo "-Wl,-bE:/opt/freeware/lib/$PERLVERSION2/CORE/perl.exp -s -L/opt/freeware/lib -Wl,-brtl -Wl,-bdynamic -L/usr/local/lib -L/opt/freeware/lib/$PERLVERSION2/CORE -lperl -lpthread -lbind -lnsl -ldl -lld -lm -lcrypt -lpthreads -lc"
else
