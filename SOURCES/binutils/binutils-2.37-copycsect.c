...
Tous les .h et .a nécessaires ne sont pas dans le package binutils...
Il faut compiler copysect AVEC les sources de binutils
...
main (int argc, char *argv[])
{
  ...
  if (!bfd_set_section_size (osect, scnlen))
    {
