...
#define PRI_TIMET_PREFIX PRI_INT_PREFIX
...
#define CLOCKID2NUM(v) LL2NUM(v)
#define NUM2CLOCKID(v) NUM2LL(v)
#define PRI_CLOCKID_PREFIX PRI_LL_PREFIX
...
#define SIZEOF_STRUCT_STAT_ST_BLOCKS SIZEOF_INT
...
#define HAVE_PTHREAD_GETTHRDS_NP 1
...
#define RUBY_PLATFORM "powerpc-aix6.1.0.0"
