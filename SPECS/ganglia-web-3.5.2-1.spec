...
# add cpu_used_report from Michael Perzl
%{__mkdir} -p $RPM_BUILD_ROOT/%{web_prefixdir}
%{__cp} -f %{SOURCE2}  $RPM_BUILD_ROOT/%{web_prefixdir}/graph.d
...
%changelog
* Fri Jul 27 2012 Patricia Cugny <patricia.cugny@bull.net> - 3.5.2-1
- update to 3.5.2
- add cpu_used_report.php from Michael Perzl
- customize conf.php 
