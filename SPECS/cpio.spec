...
%post
/sbin/install-info %{_prefix}/info/cpio.info.gz %{_prefix}/info/dir

%preun
if [ $1 = 0 ]; then
    /sbin/install-info --delete %{_prefix}/info/cpio.info.gz %{_prefix}/info/dir
fi

%files
%defattr(-,root,root)
/usr/linux/bin/*
%doc README NEWS COPYING INSTALL
%ifos linux
/bin/cpio
#/bin/mt
