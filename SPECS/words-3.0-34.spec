...
install -m644 mwords/moby $RPM_BUILD_ROOT%{_datadir}/dict/words
...
%changelog
* Thu Sep 29 2019 Etienne Guesnet <etienne.guesnet.external@atos.net> - 3.0-34
- First port on AIX
- Use perl and not dos2unix
