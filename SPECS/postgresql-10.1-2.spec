...
export LDFLAGS="-L/opt/freeware/lib64 -L/opt/freeware/lib -Wl,-blibpath:/opt/freeware/lib64:/opt/freeware/lib:/usr/lib:/lib -Wl, -lintl"
...
#	hs_primary_setup
#
#Â	RUNNING=`ps -edf | grep postgres | awk '{ if($1=="pgstbf") print $2}'`
