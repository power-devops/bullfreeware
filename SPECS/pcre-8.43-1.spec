...
BuildRequires: sed bzip2 >= 1.0.2, zlib-devel >= 1.2.3, readline-devel >= 5.2
%if %{with cmake_build}
...
%changelog
* Thu Oct 09 2019 Etienne Guesnet <etienne.guesnet.external@atos.net> - 8.43-1
