...
#Patch1001: krb5-1.12.1-pamUPDATED.patch
...
Patch1006: krb5-1.3.1-dnsUPDATED.patch

Patch1007: krb5-1.12-api.patch
Patch1008: krb5-1.13-dirsrv-accountlockUPDATED.patch
...
# Superseded by Patch1050
# Patch1020: Process-included-directories-in-alphabetical-order.patch

# Work around for Patch1020 c.f. valid_name_scandir() / prof_parse.c error on
...
#%patch1001 -p1 -b .krb5-1.12.1-pamUPDATED
...
%patch1047 -p1 -b .Fix-segfault-in-finish_dispatch.patch
%patch1048 -p1 -b .Log-when-non-root-ksu-authorization-fails.patch
%patch1049 -p1 -b .Add-k5_dir_filenames-to-libkrb5support.patch
%patch1050 -p1 -b .Process-profile-includedir-in-sorted-order.patch
%patch1051 -p1 -b .Make-docs-build-python3-compatible.patch
%patch1052 -p1 -b .Add-flag-to-disable-encrypted-timestamp-on-client.patch
%patch1053 -p1 -b .Explicitly-look-for-python2-in-configure.in.patch
%patch1054 -p1 -b .Use-SHA-256-instead-of-MD5-for-audit-ticket-IDs.patch
%patch1055 -p1 -b .Add-k5test-mark-function.patch
%patch1056 -p1 -b .Convert-Python-tests-to-Python-3.patch
%patch1057 -p1 -b .Zap-copy-of-secret-in-RC4-string-to-key.patch
%patch1058 -p1 -b .Fix-some-broken-tests-for-Python-3.patch
%patch1059 -p1 -b .Eliminate-preprocessor-disabled-dead-code.patch
%patch1060 -p1 -b .Make-krb5kdc-p-affect-TCP-ports.patch
%patch1061 -p1 -b .Remove-outdated-note-in-krb5kdc-man-page.patch
%patch1062 -p1 -b .Fix-k5test-prompts-for-Python-3.patch
%patch1063 -p1 -b .In-FIPS-mode-add-plaintext-fallback-for-RC4-usages-a.patch
%patch1064 -p1 -b .Remove-incorrect-KDC-assertion.patch
%patch1065 -p1 -b .Address-some-optimized-out-memset-calls.patch
%patch1066 -p1 -b .Avoid-allocating-a-register-in-zap-assembly.patch
%patch1067 -p1 -b .In-rd_req_dec-always-log-non-permitted-enctypes.patch
%patch1068 -p1 -b .In-kpropd-debug-log-proper-ticket-enctype-names.patch
%patch1069 -p1 -b .Add-function-and-enctype-flag-for-deprecations.patch
%patch1070 -p1 -b .Make-etype-names-in-KDC-logs-human-readable.patch
%patch1071 -p1 -b .Mark-deprecated-enctypes-when-used.patch
