...
Requires: libstdc++-devel = %{full_version}
...
Group: Development/Languages
Requires: %{name} = %{full_version}
Requires: libgfortran = %{full_version}
...
Group: Development/Languages
Requires: libgcc = %{full_version}
Requires: libgfortran%{gcc_major}
%{AIX_requirements}
...
(
	...
	ln -sf gcc/%{buildhost}/%{gcc_major}/$l .

	cd ${RPM_BUILD_ROOT}%{_libdir64}
	ln -sf ../lib/$l .

	cd ${RPM_BUILD_ROOT}%{_libdir}/pthread
	ln -sf ../gcc/%{buildhost}/%{gcc_major}/pthread/$l .
...
%{_libdir}/libgo.a
%{_libdir64}/libgo.a
%{_libdir}/pthread/libgo.a
%{_libdir}/pthread/ppc64/libgo.a
...
%changelog
* Mon Aug 09 2021 Clement Chigot <clement.chigot@atos.net> - 10-1
- Update default to gcc-10
- Add aix 7.3 configuration and remove aix 6.1
- Adjust links for libraries

* Fri Jun 25 2021 Clement Chigot <clement.chigot@atos.net> - 8-4
- Fix some requires which weren't taking epoch into account

* Tue Apr 06 2021 Clement Chigot <clement.chigot@atos.net> - 8-3
- Improvement version requirements
- Add libgfortran subpackage
- Fix dependencies for gcc-c++

* Wed Dec 02 2020 Clément Chigot <clement.chigot@atos.net> - 8-2
