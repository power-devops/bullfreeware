...
Patch20:        mariadb-10.3.10_test_result.patch
...
Patch22:        mariadb-10.4.8-compile_new_cmake.patch
...
Patch26:        mariadb-10.4.12-skip_test.patch
...
# Compile auth_socket
Patch32:        mariadb-10.3.15.auth_socket.patch
# Compile dynamic plugins
Patch33:        mariadb-10.4.8-plugin_dynamic.patch
# Import symbols for test
Patch34:        mariadb-10.4.6-symbols_test.patch
...
Patch38:        mariadb-10.4.11.ip_len.patch
...
echo "Disk space available for testing MariaDB must be >= 25 Gio"
if [ "$SO" -lt 25000000 ]
then
...
%define common_testsuite_arguments " %{_smp_parallel} --force --retry=0 --suite-timeout=900 --testcase-timeout=30 --force-restart --shutdown-timeout=60 --max-test-fail=9999 "
...
rm -r ${RPM_BUILD_ROOT}/%{_datadir}/pkgconfig
