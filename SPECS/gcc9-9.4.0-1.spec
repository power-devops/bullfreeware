...
Patch11:  gcc-9.4.0-gcc-config-force-opt-freeware-lib-in-AIX-LIBPATH.patch
...
Patch22: gcc-9.4.0-aix-handle-64bit-inodes-for-include-directories.patch

# Fix collect2 with archvies containing text files
Patch23: gcc-8.5.0-aix-collect2-text-files-in-archive.patch

# Ensure that libbacktrace doesn't crash when handling a libgo crash.
# This is workaround because fileline_fn should never be NULL if the
# initialization didn't failed.
# This is coming from a wider unknown bug.
Patch24: gcc-9.4.0-avoid-crash-in-libbacktrace.patch
...
%changelog
* Wed Jun 02 2021 Clement Chigot <clement.chigot@atos.net> - gcc9-9.4.0-1
