...
%global enablepprof 0
%global ignore_tests 1
...
# Required for patch phase
BuildRequires:  patch >= 2.5.4
...
# Merged in master
Patch1:      go-1.12-cmd-link-improve-XCOFF-symtab-implementation-20190227.patch
Patch2:      go-1.12-cmd-link-set-correct-sizes-for-XCOFF-outer-symbols-20190228.patch
Patch3:      go-1.12-runtime-use-AIX-C-ABI-in-asmcgocall-20190306.patch
Patch4:      go-1.12-runtime-handle-syscalls-without-g-or-m-for-aix-ppc64-20190306.patch
Patch5:      go-1.12-runtime-cgo-add-port-for-aix-ppc64-20190306.patch
Patch6:      go-1.12-cmd-link-runtime-allow-external-linking-for-aix-ppc6-20190306.patch
Patch7:      go-1.12-cmd-link-fix-moduledata-symbols-for-aix-ppc64-and-ex-20190306.patch
Patch8:      go-1.12-cmd-link-on-AIX-generate-export-file-for-host-linker-20190308.patch
Patch9:      go-1.12-cmd-link-enable-DWARF-with-external-linker-on-aix-pp-20190309.patch
Patch10:     go-1.12-cmd-disable-DWARF-with-old-ld-on-aix-ppc64-20190313.patch
Patch11:     go-1.12-cmd-always-allow-bigtoc-generation-with-gcc-on-aix-p-20190226.patch
Patch12:     go-1.12-cmd-link-fix-trampoline-generation-for-aix-ppc64-20190315.patch
Patch13:     go-1.12-cmd-runtime-fix-C-trampolines-on-aix-ppc64-20190319.patch
Patch14:     go-1.12-net-allow-build-on-aix-ppc64-with-cgo-20190319.patch
Patch15:     go-1.12-os-user-allow-build-on-aix-ppc64-with-cgo-20190319.patch
Patch16:     go-1.12-runtime-fix-TestSigStackSwapping-on-aix-ppc64-20190319.patch
Patch17:     go-1.12-runtime-disable-pprof-test-with-cgo-on-aix-ppc64-20190319.patch
Patch18:     go-1.12-runtime-enable-external-linker-tests-for-aix-ppc64-20190319.patch
Patch19:     go-1.12-runtime-fix-sigfwd-for-aix-ppc64-20190319.patch
Patch20:     go-1.12-cmd-internal-goobj-fix-TestParseCGOArchive-for-aix-p-20190319.patch
Patch21:     go-1.12-cmd-nm-fix-cgo-tests-for-aix-ppc64-20190320.patch
Patch22:     go-1.12-cmd-dist-misc-cgo-enable-tests-for-aix-ppc64-20190226.patch
Patch23:     go-1.12-cmd-dist-enable-cgo-for-aix-ppc64-20190320.patch
Patch24:     go-1.12-cmd-link-support-dwarf64-when-writing-debug_frame-20190306.patch
Patch25:     go-1.12-syscall-add-missing-Setrlimit-and-Termios-on-aix-ppc-20190227.patch
Patch26:     go-1.12-archive-syscall-add-statunix-for-aix-ppc64-20190228.patch

Patch28:     go-1.12-cmd-link-fix-a-with-external-linker-20190227.patch
Patch29:     go-1.12-cmd-go-fix-Wl-whole-archive-for-aix-ppc64-20190227.patch
Patch30:     go-1.12-cmd-go-pass-X64-to-ar-on-aix-ppc64-20190306.patch
Patch31:     go-1.12-syscall-add-Chroot-and-Dup2-for-aix-ppc64-20190313.patch
Patch32:     go-1.12-net-fix-fd-leak-with-interfaces-on-aix-ppc64-20190305.patch
Patch33:     go-1.12-runtime-disable-TestGdbAutotmpTypes-in-short-mode-on-20190306.patch
Patch34:     go-1.12-cmd-compile-misc-cgo-fix-fortran-tests-on-aix-ppc64-20190306.patch
Patch35:     go-1.12-syscall-fix-returned-values-of-Dup2-on-aix-ppc64-20190322.patch
Patch36:     go-1.12-cmd-link-enable-buildmode-pie-on-aix-ppc64-20190322.patch
Patch37:     go-1.12-runtime-improve-sigtramp-on-aix-ppc64-to-handle-SIGP-20190326.patch
Patch38:     go-1.12-runtime-create-library-startup-for-aix-ppc64-20190327.patch
Patch39:     go-1.12-cmd-link-allow-buildmode-c-archive-for-aix-ppc64-20190327.patch
Patch40:     go-1.12-cmd-go-add-a-note-in-help-buildmode-for-c-archive-on.20190403.patch
Patch41:     go-1.12-runtime-cmd-dist-misc-cgo-enable-c-archive-for-aix-p.20190403.patch
# Patch42:     go-1.12-syscall-on-AIX-use-nsendmsg-and-nrecvmsg-define-Sock-20190403.patch
Patch43:     go-1.12-net-retrieve-if-unix-network-is-available-only-once-20190412.patch
Patch44:     go-1.12-runtime-move-libcall-to-stack-for-syscall-package-on-20190412.patch
Patch45:     go-1.12-syscall-add-aix-to-syscall_unix_test-go-20190412.patch
Patch46:     go-1.12-runtime-remove-debug-prints-in-netpoll_aix-go-20190412.patch
Patch47:     go-1.12-runtime-add-cgo_unsafe_args-to-syscallX-functions-on-20190412.patch

# Others patches
Patch27:     go-1.12-runtime-call-atomic.Storeuintptr-in-noteclear-on-AIX-20190513.patch

Patch48:     go-1.12-cmd-internal-obj-ppc64-Fix-ADUFFxxxx-generation.patch
...
%prep
# The original $SOURCES/go1.x.src.tar.gz expands as go/* with: %setup -q -n go
# I prefer to have go-%{go_version}
# Do before:
 # mkdir /tmp/goo
 # cd /tmp/goo
 # tar zxf $SOURCES/go${go_version}.src.tar.gz
 # mv go go-%{go_version}
 # mv $SOURCES/go${go_version}.src.tar.gz $SOURCES/go${go_version}.src.tar.gz.ORIGIN
 # tar zcf $SOURCES/go${go_version}.src.tar.gz go-%{go_version}/*
 # tar ztf $SOURCES/go${go_version}.src.tar.gz | head
...
%else
echo "pprof breaks the golang-bin package !"
    $FWFIND bin/ pkg/   -type d -a ! -path '*_dynlink/*' -a ! -path '*_race/*' -printf '%%%dir %{goroot}/%p\n' | grep -v golang/pkg/obj/go-build/ | grep -v aix_ppc64/pprof >> $bin_list
    $FWFIND bin/ pkg/ ! -type d -a ! -path '*_dynlink/*' -a ! -path '*_race/*' -printf        '%{goroot}/%p\n' | grep -v golang/pkg/obj/go-build/ | grep -v aix_ppc64/pprof >> $bin_list
%endif
...
mkdir -p $RPM_BUILD_ROOT%{goroot}/bin/aix_%{gohostarch}
ln -sf ../go $RPM_BUILD_ROOT%{goroot}/bin/aix_%{gohostarch}/go
ln -sf ../gofmt $RPM_BUILD_ROOT%{goroot}/bin/aix_%{gohostarch}/gofmt
...
# Temporary. Eliminate File listed twice (doc !):
#	/opt/freeware/lib/golang/doc/*
rm -rf $RPM_BUILD_ROOT%{goroot}/doc
...
%changelog
* Fri Oct 18 2019 Clément Chigot <clement.chigot@atos.net> - 1.12.12 - 1
- Update to version 1.12.12
- Add fix for #34604

* Thu Sep 26 2019 Clément Chigot <clement.chigot@atos.net> - 1.12.10 - 1
- Update to version 1.12.10

* Mon Aug 26 2019 Clément Chigot <clement.chigot@atos.net> - 1.12.9 - 1
- Update to version 1.12.9
- Add %clean

* Tue Jul 9 2019 Clément Chigot <clement.chigot@atos.net> - 1.12.7 - 1
- Update to version 1.12.7

* Thu Jun 13 2019 Clément Chigot <clement.chigot@atos.net> - 1.12.6 - 1
- Update to version 1.12.6

* Mon May 7 2019 Clément Chigot <clement.chigot@atos.net> - 1.12.5 - 1
- Update to version 1.12.5
- Improve runtime, syscall and net packages
- Fix GOROOT generation

* Thu Apr 08 2019 Clément Chigot <clement.chigot@atos.net> - 1.12.2 - 1
