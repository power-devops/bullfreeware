...
Patch1:    %{name}-%{version}.int64-lld-v2.patch
...
Patch3:     %{name}-1.9.4-topology-scanner-v2.patch
...
%patch0 -p1 -b .rpm
%patch1 -p1 -b .int64-lld-v2
%if %{gcc_compiler} == 0
%patch2 -p1 -b .XLC-bug
%endif
%patch3 -p1 -b .topology-scanner-v2
...
%changelog
* Tue Apr 24 2018 Tony Reix <tony.reix@atos.net> - 1.9.4-4
- Change patches with #ifdef _AIX
