...
Patch31:        mariadb-10.3.15-skip_unskip_test.patch
...
gmake %{?_smp_mflags} VERBOSE=1 -j8
...
%changelog
* Wed Jun 19 2019 Etienne Guesnet <etienne.guesnet.external@atos.net> - 10.3.15-2
- Innodb is available.
- Use GNU iconv.
