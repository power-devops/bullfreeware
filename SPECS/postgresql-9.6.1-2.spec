# compiler par defauft xlc, defaut dotests 1, default_bits 64  
...
Source13: %{name}-%{version}-2.resultats.ksh
# Script of passing tests base + Tap + extras ...
Source14: %{name}-%{version}-2.run_all_tests.ksh
...
%if %{gcc_compiler} == 1
echo "GCC version=`øpt/freeware/bin/gcc --version | head -1`"
%endif
