...
%{!?gcc_compiler: %global gcc_compiler 0}

# By default, dotests are run.
# No tests: rpmbuild -ba --without dotests *.spec
%bcond_without dotests

%{!?default_bits: %global default_bits 64}
...
BuildRequires: python-devel >= 2.7.18
%endif
...
BuildRequires: readline-devel >= 8.0.4
Requires: readline >= 8.0.4
...
Requires: openldap >= 2.4.54
%endif

%if %nls
BuildRequires: gettext >= 0.20.1
...
# Not good for autobuild. And only needed for tests.
#	ulimit -s unlimited
#	ulimit -m unlimited
#	ulimit -d unlimited
ulimit -a
...
export PYTHON=/opt/freeware/bin/python2.7_32
...
%changelog
* Thu Aug 26 2021 Tony Reix <tony.reix@atos.net> - 11.13-1
- Move to v11.13
- Adapt .spec to brpm
- Suppress /usr symlinks
- Update BuildRequires: and Requires: to fresh versions of packages (perl, python, ...)
- Still using Python v2
- Reorganize the packages for passing brpm
...
* Thu Aug 25 2011 Michael Perzl <michael@perzl.org> - 9.0.4-1
- updated to version 9.0.4

* Thu Aug 25 2011 Michael Perzl <michael@perzl.org> - 9.0.3-1
