...
Patch1:     sudo-1.9.5p2-exppasswd2-aix.patch
...
# them for .a.
Patch3:     sudo-1.9.8-aix-remove-brtl-in-configure.patch

# Force libtool to use .exp provided by sudo and not
# generate its own.
Patch4:     sudo-1.9.8-keep_LT_LDEXPORTS_for_aix.patch
...
%changelog
* Fri Nov 05 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 1.9.8-1
- Update to 1.9.8
