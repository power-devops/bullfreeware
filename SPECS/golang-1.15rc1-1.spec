...
# This seems to depend where the tarball have been generated.
# Taking the tarball from Go website is ok. But regenerating it
# on AIX is not.
# Thus, these lines might be commented or not depending on it.
...
%changelog
* Mon Jul 27 2020 Clément Chigot <clement.chigot@atos.net> - 1.15rc1-1
