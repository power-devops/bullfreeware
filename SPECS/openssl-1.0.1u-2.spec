...
%changelog
* Thu Nov 24 2016 Tony Reix <tony.reix@atos.net> - 1.0.1u-2
- Big change:
  strip -e ALL .so files but the libssl.so.1.0.2 in libssl.a & libcrypto.a !!

* Thu Sep 22 2016 Tony Reix <tony.reix@atos.net> - 1.0.1u-1
- Update to version 1.0.1u on AIX 6.1

* Mon May 09 2016 Tony Reix <tony.reix@atos.net> - 1.0.1t-1
- Update to version 1.0.1t on AIX 6.1

* Wed Jan 03 2016 Tony Reix <tony.reix@atos.net> - 1.0.2r-1
- Fix issue with gmake test for 64bits

* Tue Jan 02 2016 Tony Reix <tony.reix@atos.net> - 1.0.2r-1
- Update to version 1.0.2r on AIX 6.1
