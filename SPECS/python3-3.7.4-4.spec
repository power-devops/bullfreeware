...
%if %{with gcc_compiler}
    # GCC
    ${CC} -shared    libpython%{BASE_VERSION}%{VERSION_SUFFIX}.a -o libpython%{BASE_VERSION}%{VERSION_SUFFIX}.so -Wl,-bE:libpython.exp -lm -lpthreads -lintl -Wl,-blibpath:$1:/opt/freeware/lib:/usr/lib:/lib
%else
    # xlc
${CC} -qmkshrobj libpython%{BASE_VERSION}%{VERSION_SUFFIX}.a -o libpython%{BASE_VERSION}%{VERSION_SUFFIX}.so     -bE:libpython.exp -lm -L/opt/freeware/lib -lintl -blibpath:$1:/opt/freeware/lib:/usr/lib:/lib
%endif
    rm -f libpython.exp
