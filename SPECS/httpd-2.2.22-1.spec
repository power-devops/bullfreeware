...
#    --with-included-apr --prefix=%{prefix}/apache2 \
...
# XXX - hack
[[ ! -d /opt/freeware/apache2/lib ]] && mkdir -p /opt/freeware/apache2/lib
[[ ! -f /opt/freeware/apache2/lib/libapr-1.so ]] && \
  cp ./srclib/apr/.libs/libapr-1.so %{prefix}/apache2/lib/libapr-1.so

make LIBPATH="$RPM_BUILD_ROOT/opt/freeware/apache2/lib:/opt/freeware/lib" DESTDIR=$RPM_BUILD_ROOT root=$RPM_BUILD_ROOT install

##  /usr/bin/strip $RPM_BUILD_ROOT/%{prefix}/apache2/bin/*  || :
...
( cd /usr/include
[ ! -d %{prefix}/apache2/include ] && mkdir -p %{prefix}/apache2/include
for file in $(find %{prefix}/apache2/include)
do
  ln -sf $file .
done
