...
# Requires to use /opt/freeware/bin/tar
# If issue, change $PATH with /opt/freeware/bin/ first
...
%changelog
* Tue Oct 29 2018 Tony Reix <tony.reix@bull.net> - 6.5.0-1
- Initial port on AIX

* Tue Jul 04 2017 Tony Reix <tony.reix@bull.net> - 6.4.0-1
- Initial port on AIX 6.1

* Tue Feb 03 2017 Tony Reix <tony.reix@bull.net> - 6.3.0-1
- Initial port on AIX 6.1
