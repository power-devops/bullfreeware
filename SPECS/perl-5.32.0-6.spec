...
# TODO
# Old ulimit when check in build
# If OK, remove it.
#ulimit -a
ulimit -d 4000000
## ulimit -s unlimited
...
(
   ...
   ln -sf perl_64 perl%{major_version}_64
)
cd ..
...
#       /usr/bin/strip ${f}_32 || :
    ...
    ln -sf perl_32 perl%{major_version}_32
    ln -sf perl%{major_version}_%{default_bits} perl%{major_version}
)
