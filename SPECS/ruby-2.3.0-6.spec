...
Patch21: ruby-2.3.0-skip_test_aix.patch
...
sed -e 's;-blibpath:${prefix}/lib;&64;' -e 's;blibpath:%1\\$-s:${prefix}/lib;&64;'     <configure.in.save > configure.in
cd ..
...
%changelog
* Wed Oct 12 2016 Jean Girardet <jean.girardet@atos.net> 2.3.0-6
- Fix 64bit configure and add devel package

* Thu Oct 06 2016 Jean Girardet <jean.girardet@atos.net> 2.3.0-4
- Add 64bit build and install 2.3.0
