...
%global doprepstage    0
%global dobuildstage   0
%global doinstallstage 0
...
Patch1015:	mysql-8.0.16-group_replication.patch
...
if [ -f ./build/CMakeFiles/CMakeError.log ]
then
    mv ./build/CMakeFiles/CMakeError.log ./build/CMakeFiles/CMakeError.log.old
fi
...
#export CXX="/opt/freeware/bin/g++.MySQL"
...
export LIBPATH=$BUILD/mysql-%{version}/build/library_output_directory:/opt/freeware/lib/pthread/ppc64:/opt/freeware/lib64:/opt/freeware/lib:/usr/lib

%global optflags -O0 -g
...
# Trace and Debug :
#	 --debug-trycompile --debug-output --trace 
...
%endif
         ...
         -DCMAKE_C_FLAGS="  $CCFLAGS  %{optflags}%{?with_debug: -fno-strict-overflow -Wno-unused-result -Wno-unused-function -Wno-unused-but-set-variable}" \
         -DCMAKE_CXX_FLAGS="$CXXFLAGS %{optflags}%{?with_debug: -fno-strict-overflow -Wno-unused-result -Wno-unused-function -Wno-unused-but-set-variable}" \
...
# Useful for listing the variables
#cmake .. -LAH


# Using -jN with N!=1 leads to issues...
gmake VERBOSE=1 -j1
...
gmake VERBOSE=1 DESTDIR=%{buildroot} install
...
ln -fs %{_libexecdir}/mysqld %{buildroot}%{_sbindir}/mysqld
