...
# Patch for merging *.exp and exports.txt for libpq.a and Co
Patch10:  %{name}-%{version}-MergeExports.patch
...
chmod 0755 ./src/backend/port/aix/mergeldexport.sh
...
* Mon Dec 03 2020 Tony Reix <tony.reix@atos.net> - 13.1-1
- Move to v13
