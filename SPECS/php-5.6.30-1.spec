...
$AR  -X32 -q ${RPM_BUILD_ROOT}%{_libdir}/httpd/modules/libphp5.a ${RPM_BUILD_ROOT}/%{_libdir}/httpd/modules/libphp5.so
$AR  -X64 -q ${RPM_BUILD_ROOT}%{_libdir}/httpd/modules/libphp5.a ${RPM_BUILD_ROOT}/%{_libdir64}/httpd/modules/libphp5.so
