...
Source: ftp://ftp.gnu.org/gnu/autoconf/%{name}-%{version}.tar.bz2
Requires: m4
...
cp config/install-sh $RPM_BUILD_ROOT%{_prefix}/share/autoconf
...
%post
/sbin/install-info %{_prefix}/info/autoconf.info.gz %{_prefix}/info/dir

%preun
/sbin/install-info --del %{_prefix}/info/autoconf.info.gz %{_prefix}/info/dir

%files
%defattr(-,root,system)
%{_prefix}/info/autoconf.info*
