...
%changelog
* Wed Oct 28 2020 Bullfreeware Continuous Integration <bullfreeware@atos.net> - 4.1.0-1
- Update to 4.1.0

* Wed Oct 28 2020 Étienne Guesnet <etienne.guesnet@atos.net> - 4.0.2-4
- Update specfile for automated build

* Tue Apr 30 2020 Étienne Guesnet <etienne.guesnet.external@atos.net> - 4.0.2-3
