...
Source0: ftp://ftp.gnutls.org/pub/%{name}/%{name}-%{version}.tar.xz
Source1: ftp://ftp.gnutls.org/pub/%{name}/%{name}-%{version}.tar.xz.sig
...
Patch1: %{name}-3.4.15-netstat.patch
