...
Patch1:     mariadb-connector-odbc-3.1.11-export.patch
Patch2:     mariadb-connector-odbc-3.1.2-strstr.patch
Patch3:     mariadb-connector-odbc-3.1.11-iconv.patch
...
Group:      Servers
License:    LGPLv2+
Source:     https://downloads.mariadb.com/Connectors/odbc/connector-odbc-%{version}/%{name}-%{version}-ga-src.tar.gz
