...
# A long standing latent error with DFS links, code unchanged since version 4
Patch5: samba-4.7.10-msdfs-aix.patch

Patch6: samba-4.7.10-Struc_bad_initialization.patch
...
%changelog
* Thu Oct 04 2018 Michael Wilson <michael.a.wilson@atos.net> - 4.7.10-2
- Work around a long standing latent error with readlink (DFS links)
