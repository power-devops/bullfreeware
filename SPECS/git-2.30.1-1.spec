...
Source1: 	http://mirrors.edge.kernel.org/pub/software/scm/git/%{name}-%{version}.tar.sign
...
Source5: 	https://mirrors.edge.kernel.org/pub/software/scm/git/%{name}-htmldocs-%{version}.tar.sign
Source6: 	https://mirrors.edge.kernel.org/pub/software/scm/git/%{name}-manpages-%{version}.tar.xz
Source7: 	https://mirrors.edge.kernel.org/pub/software/scm/git/%{name}-manpages-%{version}.tar.sign
