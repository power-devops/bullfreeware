...
# Fake url: from https://github.com/p11-glue/p11-kit/releases, you can found all releases
# but true url is one of
# https://github.com/11-glue/p11-kit/releases/download/%{name}-%{version}/%{name}-%{version}.tar.gz
# https://github.com/11-glue/p11-kit/archive/%{name}-%{version}.tar.gz
# However, from the true url, you cannot find the newest easily...
Source0:        https://github.com/p11-glue/p11-kit/releases/%{name}-%{version}.tar.xz
Source1:        https://github.com/p11-glue/p11-kit/releases/%{name}-%{version}.tar.xz.sig
...
BuildRequires:  gettext, compat-getopt-devel
BuildRequires:  libtasn1-devel, libffi-devel
BuildRequires:  pkg-config
Requires:       gettext, compat-getopt
Requires:       libtasn1, libffi
...
export PATH=/usr/bin:/opt/freeware/bin:/usr/sbin:/usr/ucb:/usr/bin/X11:/sbin:.
...
export CXX="/opt/freeware/bin/gcc"
...
export LDFLAGS="-lp11-kit -lcompat-getopt -L./p11-kit/.libs -L/opt/freeware/lib64 -L/opt/freeware/lib -Wl,-blibpath:/opt/freeware/lib64:/opt/freeware/lib:/usr/lib:/lib"
...
./configure \
    --prefix=%{_prefix} \
    --libdir=%{_libdir64} \
    --with-trust-paths=%{_datadir}/pki/ca-trust-source \
    --without-systemd \
...
export LDFLAGS="-lp11-kit -lcompat-getopt -L./p11-kit/.libs -L/opt/freeware/lib -Wl,-blibpath:/opt/freeware/lib:/usr/lib:/lib -Wl,-bmaxdata:0x80000000"
...
%changelog
* Tue Apr 20 2021 Tony Reix <tony.reix@atos.net> - 0.23.22-1
- Update to 0.23.22

* Fri Oct 16 2020 Bullfreeware Continuous Integration <bullfreeware@atos.net> - 0.23.21-2
- Update to 0.23.21

* Wed Oct 14 2020 Étienne Guesnet <etienne.guesnet@atos.net> - 0.23.21-1
- New version 0.23.21
- Correct trust path
- Provide .so for pkcs11 modules

* Wed Apr 01 2020 Étienne Guesnet <etienne.guesnet.external@atos.net> - 0.23.20-1
- updated to version 0.23.20
- stop providing .la, .so and link to /usr
- add check section
