...
$AR -X64 -q ${RPM_BUILD_ROOT}%{_libdir}/libgmp.a 64bit/.libs/libgmp.so.10

# Make the 64bits version of libgmp.a as a symbolic link to the 32bits version
$RM ${RPM_BUILD_ROOT}%{_libdir64}/libgmp.a
cd  ${RPM_BUILD_ROOT}%{_libdir64}
ln -s ../lib/libgmp.a libgmp.a
cd -
...
$AR -X32 -q ${RPM_BUILD_ROOT}%{_libdir}/libgmp.a libgmp.so.3

cp %{SOURCE4} libgmp.so.3
/usr/bin/strip -X64 -e libgmp.so.3
$AR -X64 -q ${RPM_BUILD_ROOT}%{_libdir}/libgmp.a libgmp.so.3
...
%changelog
* Fri Apr 01 2016 Maximilien Faure <maximilien.faure@atos.net>
- Fixes for ar and 32/64 bits

* Wed Mar 30 2016 Maximilien Faure <maximilien.faure@atos.net>
