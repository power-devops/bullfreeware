...
# Required for sed of %find_lang (/usr/opt/rpm/lib/rpm/find-lang.sh)
BuildRequires: sed
# Required for testing: xargs -0 ...
...
# /usr/opt/rpm/lib/rpm/find-lang.sh makes use of: sed -r ...
...
%changelog
* Thu Jan 07 2021 Tony Reix <tony.reix@atos.net> - 7.4.2-1
- Initial release to AIX toolbox

* Fri Aug 14 2020 Baanu Tumma <btumma15@in.ibm.com> - 7.4.1-1
- Initial release to AIX toolbox
...
* Thu Feb 28 2002 Trond Eivind GlomsrÃ¸d <teg@redhat.com> 3.1-10
