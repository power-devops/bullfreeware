...
%files
%defattr(-,root,root,-)
%doc README NEWS INSTALL LICENSE COPYING
%{_bindir}/less
%{_bindir}/lesskey
%{_bindir}/lessecho
/usr/bin/*
...
%changelog
* Thu Apr 28 2016 Michael Wilson <michael.wilson@atos.net> 481
- update to version 481 for AIX

* Wed Apr 28 2010 Jean Noel Cordenner <jean-noel.cordenner@bull.net> 4.36
- update to version 4.36 for AIX
