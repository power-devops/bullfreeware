...
BuildRequires:	AIX-rpm >= 5.3.0.0, zlib-devel, make, gcc >= 4.5.4-1, coreutils
BuildRequires:	patch, tar
BuildRequires:	python >= 2.7.13-1
Requires:	AIX-rpm >= 5.3.0.0, zlib, bash
...
* Wed Nov 18 2014 Michael Perzl <michael@perzl.org> - 2.1.14-1
