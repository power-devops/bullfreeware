...
export LDFLAGS32="-Wl,-brtl -Xlinker -bmaxdata:0x80000000"
export LDFLAGS64="-Wl,-brtl"
...
%changelog
* Fri Feb 07 2020 Michael Wilson <michael.a.wilson@atos.net> - 5.45.4-2
- Rebuild on laurel2 for expect 5.45.4
-   Rebuild expect required for dejagnu configure/build of new version
- Thu MAY 28 2020  align to changes in tcl-8.6.10-1.spec
