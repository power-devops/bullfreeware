...
#for python export FLAG64="-maix64 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_LARGE_FILES
...
#        -Dlddlflags="$LDFLAGS" \ ko
#-Dso=a \
#	-A define:ld='$CC' \
#	-A define:lddlflags='-bexpall -G $LIBS' \
...
#        -Dd_dosuid \ doesnot exist after perl 5.12
#        -Dalignbytes=8 \
#        -Dso=a \
...
(
  ...
  export LDFLAGS32="$LDFLAGS32 -Wl,-blibpath:%{_libdir}/perl5/%{perlver}/ppc-aix-thread-multi/CORE:%{_libdir}:/usr/lib:/lib"
...
(
  ...
  export LDFLAGS64="$LDFLAGS64 -Wl,-blibpath:%{_libdir}/perl5/%{perlver}/ppc-aix-thread-multi-64all/CORE:%{_libdir}/perl5/%{perlver}/ppc-aix-thread-multi/CORE:%{_libdir64}:%{_libdir}:/usr/lib:/lib"
...
# 32-bit libperl.o
# Add the 64 bit object to the 32/64 bits archive
$AR -X32_64 -q ${RPM_BUILD_ROOT}%{_libdir}/perl5/%{perlver}/ppc-aix-thread-multi/CORE/libperl.a ${RPM_BUILD_ROOT}%{_libdir}/perl5/%{perlver}/ppc-aix-thread-multi-64all/CORE/libperl.o

# Create 64bit lib link
# Usual stuff for other packages may be irrelevant for perl
...
mkdir -p ${RPM_BUILD_ROOT}%{_libdir}/perl5/vendor_perl
mkdir -p ${RPM_BUILD_ROOT}%{_libdir64}/perl5/vendor_perl
...
#
#cat ${RPM_BUILD_ROOT}%{_libdir}/perl5/%{perlver}/ppc-aix-thread-multi-64all/copy.Config_heavy.pl.copy \
#	| sed -e 's@-bE:.*tmp/perl-root@-bE:@' \
#	| sed -e "s|$RPM_BUILD_ROOT||g" \
#> ${RPM_BUILD_ROOT}%{_libdir}/perl5/%{perlver}/ppc-aix-thread-multi-64all/Config_heavy.pl
#
...
#
#cat ${RPM_BUILD_ROOT}%{_libdir}/perl5/%{perlver}/ppc-aix-thread-multi/copy.Config_heavy.pl.copy \
#	| sed -e 's@-bE:.*tmp/perl-root@-bE:@' \
#	| sed -e "s|$RPM_BUILD_ROOT||g" \
#> ${RPM_BUILD_ROOT}%{_libdir}/perl5/%{perlver}/ppc-aix-thread-multi/Config_heavy.pl
#
...
PERL	= PERL5LIB=\$(PERLLIB) LIBPATH=\$(RPM_BUILD_ROOT)%{_libdir}/perl5/%{perlver}/ppc-aix-thread-multi/CORE:%{_libdir}:/usr/lib \$(RPM_BUILD_ROOT)%{_bindir}/perl
...
* Thu Dec 02 2016 Michael Wilson <michael.wilson@bull.net> 5.24.0-1
