...
%define orbit2_version 2.14.3
%define glib2_version 2.12.4
%define popt_version 1.7
%define gtk_doc_version 1.7
...
Patch0:		GConf-2.14.0-aix.patch
Patch1:		GConf-2.14.0-autotools.patch
...
$PATCH -p2 -s < %{_sourcedir}/GConf-2.14.0-aix.patch
$PATCH -p2 -s < %{_sourcedir}/GConf-2.14.0-autotools.patch
