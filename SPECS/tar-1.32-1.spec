...
%build
export CFLAGS_COMMON="$RPM_OPT_FLAGS -D_LARGEFILE_SOURCE -D_LARGE_FILES -D_LINUX_SOURCE_COMPAT"
...
export CFLAGS="$CFLAGS_COMMON -D_FILE_OFFSET_BITS=64"
build_tar

cd ../32bit
export OBJECT_MODE=32

export CC="/opt/freeware/bin/gcc -maix32 -D_LARGE_FILES"
export LDFLAGS="-Wl,-bmaxdata:0x80000000 -Wl,-blibpath:/opt/freeware/lib:/usr/lib"
export CFLAGS="$CFLAGS_COMMON -D_FILE_OFFSET_BITS=32"
build_tar
