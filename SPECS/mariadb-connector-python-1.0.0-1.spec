...
License:        LGPL
URL:            https://downloads.mariadb.org/interstitial/connector-python-%{version}/mariadb-connector-python-%{version}.tar.gz
Source0:        %{name}-%{version}.tar.gz
Source1000:     %{name}-%{version}-%{release}.build.log
Patch1:         mariadb-connector-python-1.0.0-arraysize_64.patch
