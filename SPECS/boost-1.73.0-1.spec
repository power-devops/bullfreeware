...
Patch1008: boost-1.69.0-NoDebug.patch
#               Patch1008: boost-1.69.0-DebugDwarf.patch
Patch1108: boost-1.69.0-MCModelLarge.patch
...
# In order to use GCC v9 instead of GCC v8 (default)
# Boost makes use of the first g++ found in the PATH
%if %{GCC_Version} == 9
echo "Building with GCC v9 !!!!"
rm -rf /tmp/g++boost
mkdir  /tmp/g++boost
AIXVersion=`uname -a | awk '{print($4 "." $3)}'`
ln -s /opt/freeware/bin/powerpc-ibm-aix${AIXVersion}.0.0-g++-9 /tmp/g++boost/g++
ln -s /opt/freeware/bin/powerpc-ibm-aix${AIXVersion}.0.0-gcc-9 /tmp/g++boost/gcc
