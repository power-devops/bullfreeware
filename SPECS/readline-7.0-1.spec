...
Patch1: readline70-001.patch
Patch2: readline70-002.patch
Patch3: readline70-003.patch
...
/usr/bin/nm -X64 shlib/libreadline.so.%{major} | grep bcopy

cp shlib/libhistory.so.%{major} 64bit/
cp shlib/libreadline.so.%{major} 64bit/
make distclean
...
# Check the bcopy issue
/usr/bin/nm -X32 shlib/libreadline.so.%{major} | grep bcopy
...
%changelog
* Wed Jul 03 2018 Tony Reix <tony.reix@atos.net> - 7.0-1
- Version 7.0
