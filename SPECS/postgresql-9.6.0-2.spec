...
%if %runselftest
    ...
    su - %{TESTUSER} -c  "(set -x;cd $ICI/src/test/regress||exit 1;$MAKE all||exit 2;$MAKE MAX_CONNECTIONS=5 check 2>&1||exit3;exit 0)"
...
for i in ecpg ecpg_compat pgtypes pq ; do
