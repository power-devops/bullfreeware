...
Patch1: %{name}-%{version}-zfree.patch
Patch2: %{name}-%{version}-regcache.patch
Patch3: %{name}-%{version}-multiosdir.patch
...
%changelog
* Mon Aug 22 2011 Patricia Cugny <patricia.cugny@bull.net> 7.3-1
