...
%define EAPI_vers  2.8.19
%define apache_vers 1.3.31
%define ssl_vers 0.9.6m
...
# Apply patches to the mod_ssl directory
# If any mod_ssl patches, put them here.
%patch2 -p1 -b .sslfree
...
OPTIM="$OPTIM" \
./configure --with-apache=../apache_%{apache_vers} --with-ssl=../openssl-%{ssl_vers} \
