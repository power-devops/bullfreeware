...
Patch1:		lz4-1.8.0-xlc-gcc.patch
...
gmake DESTDIR=${RPM_BUILD_ROOT} PREFIX=%{_prefix} LIBDIR=%{_libdir64} install
(
...
gmake DESTDIR=${RPM_BUILD_ROOT} PREFIX=%{_prefix} LIBDIR=%{_libdir} install
