...
%global _samba4_pdb_modules pdb_tdbsam,pdb_ldap,pdb_smbpasswd,pdb_wbc_sam,pdb_samba4

%global _samba4_auth_modules auth_unix,auth_wbc,auth_server,auth_script,auth_samba4
...
-     wscript_build must specify an entrypoint for the WINBIND module
