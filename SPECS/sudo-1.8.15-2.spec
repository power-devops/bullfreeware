...
Name: sudo
Version: 1.8.15
Release: 2%{?noldap:noldap}
Group: Applications/System
License: IBM_ILA
Source: http://www.sudo.ws/sudo/dist/sudo-1.8.15.tar.gz
Source1: IBM_ILA
...
%if %{LDAP} == 1
	...
	--with-ldap-secret-file=/etc/openldap/ldap.secret
%endif
...
%preun
rm -rf /var/run/sudo/*
rm -rf /var/lib/sudo/lectured/*

%changelog
* Wed Mar 16 2016 Laurent GAY <laurent.gay@atos.net> 1.8.15-2
- Update to 1.8.15
