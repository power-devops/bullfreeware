...
BuildRequires: openssl-devel >= 1.0.0d, pkg-config, libidn-devel >= 1.24
...
/usr/bin/ar -X64 -q lib/.libs/libcurl.a ./libcurl.so.4
...
- update version to 7.28.0 on 3Ã2 and 64 bit
