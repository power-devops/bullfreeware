...
(
	...
	for f in libodbc libodbccr libodbcinst; do
		...
		${AR} -x -X64 ${f}.a
		${AR} -q -X64 ${RPM_BUILD_ROOT}%{_libdir}/${f}.a ${f}.so.%{major_version}
...
%changelog
* Thu Oct 08 2020 Bullfreeware Continuous Integration <bullfreeware@atos.net> - 2.3.9-1
- Update to 2.3.9

* Wed Oct 07 2020 Étienne Guesnet <etienne.guesnet.external@atos.net> - 2.3.7-3
- Remove old and wrongly named .so
- Use %{major_version}.%{minor_version} as Version 
- Add url for source
