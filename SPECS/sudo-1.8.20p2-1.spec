...
# For: check_symbols test.
#  Issue with libcrypto.a(libcrypto.so.1.0.2)
#  Mess between AIX & BullFreeware version of openssl.
...
%changelog
* Tue Jun 02 2017 Tony Reix <tony.reix@atos.net> 1.8.20p2-1
