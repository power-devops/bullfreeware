...
Patch0: gawk-3.1.8-xlcconf.patch
Prefix: %{_prefix}
...
(cd $RPM_BUILD_ROOT
  gzip -9nf .%{_prefix}/share/info/gawk.info*
  gzip -9nf .%{_prefix}/share/info/gawkinet.info*
...
%post
/sbin/install-info %{_prefix}/share/info/gawk.info.gz %{_prefix}/share/info/dir
/sbin/install-info %{_prefix}/share/info/gawkinet.info.gz %{_prefix}/share/info/dir

%preun
if [ $1 = 0 ]; then
   /sbin/install-info --delete %{_prefix}/share/info/gawk.info.gz %{_prefix}/share/info/dir
   /sbin/install-info --delete %{_prefix}/share/info/gawkinet.info.gz %{_prefix}/share/info/dir
fi
