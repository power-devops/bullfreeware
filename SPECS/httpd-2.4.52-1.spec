...
Source9:    %{name}-2.4.52-configure-adapt-for-64bit.patch
Source10:   %{name}-2.4.41.conf64.patch
Source11:   %{name}-2.4.52-tests-fix-PL_hash_seed-addressing-in-modperl.patch
...
# TODO: We are currently using mod_perl. But Fedora has moved to something else.
...
tar -xzvf %{SOURCE1}
cd mod_perl-*
# Fix error related to PL_hash_seed
# https://github.com/Perl/perl5/issues/18617
patch -p1 < %{SOURCE11}

if [[ ${OBJECT_MODE} == "32" ]]; then
    export PERL=%{__perl32}
else
    export PERL=%{__perl64}
fi
...
#   sed -i 's|PERL = /opt/freeware/bin/perl|PERL = /opt/freeware/bin/perl5.34.0_32|g' Makefile
# fi
gmake
...
then
  ...
  grep -R -l "#\!/opt/freeware/bin/perl$"  | xargs sed -i "s|#\!/opt/freeware/bin/perl|#!${PERL}|g"
#  grep -R /opt/freeware/bin/perl3232 *                               | awk -F: '{print $1}' | xargs sed -i "s|/opt/freeware/bin/perl3232|/opt/freeware/bin/perl|g"
fi
...
%changelog
* Sat Jan 08 2022 Bullfreeware Continous Integration <bullfreeware@atos.net> - 2.4.52-1
- Update to 2.4.52

* Mon Oct 11 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 2.4.51-1
- Update to 2.4.51

* Thu Oct 07 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 2.4.50-1
- Update to 2.4.50

* Sat Sep 18 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 2.4.49-1
- Update to 2.4.49

* Mon Aug 09 2021 Clément Chigot <clement.chigot@atos.net> - 2.4.48-3
- Adjust Source0 URL
