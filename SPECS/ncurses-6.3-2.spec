...
Requires: libgcc >= 10.3.0-1
Requires: libstdc++ >= 10.3.0-1
...
%changelog
* Mon Dec 06 2021 Etienne Guesnet <etienne.guesnet@atos.net> - 6.3-2
- Provide include files in %{_includedir} and %{_includedir}/ncurses

* Sat Oct 23 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 6.3-1
- Update to 6.3
