...
# CRYT and not CRYPT used... Reported.
Patch10:      mariadb-connector-c-3.1.4-CRYPT.patch
...
%package config
Summary:        Configuration files for packages that use /opt/freeware/etc/my.cnf as a configuration file
Group:          config 
BuildArch:      noarch
...
%changelog
* Tue Oct 03 2019 Etienne Guesnet <etienne.guesnet.external@atos.net> - 3.1.4-2
- Correct config file
