...
%post
/sbin/install-info %{_prefix}/share/info/diffutils.info.gz %{_prefix}/share/info/dir --entry="* diff: (diff).                 The GNU diff."

%preun
if [ $1 = 0 ]; then
    /sbin/install-info --delete %{_prefix}/share/info/diffutils.info.gz %{_prefix}/share/info/dir --entry="* diff: (diff).                 The GNU diff."
fi
...
%{_prefix}/bin/*
%{_prefix}/share/info/diffutils.info*gz
/usr/linux/bin/*
