...
# Others patches
Patch27:     go-1.12-runtime-perform-atomic-Load-on-sched-values-20190226.patch
Patch43:     go-1.12-runtime-move-libcall-to-stack-for-syscall-package-on-20190408.patch

Source100:      golang-gdbinit

%description
The Go Programming Language source tree v1.12.2 for AIX 7.2 / Power >= 8.
...
%else
export GOROOT_BOOTSTRAP=%{gorootboot}
%endif

# set up final install location
export GOROOT_FINAL=/tmp/go-%{go_version}-final
...
# Use the go provided in gorootboot
