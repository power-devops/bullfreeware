...
%changelog
* Thu Jun 09 2016 Tony Reix <tony.reix@bull.net> - 4.8.5-5
...
* Wed Jun 08 2016 Tony Reix <tony.reix@bull.net> - 4.8.4-6
- Port on AIX 7.2

* Mon May 30 2016 Tony Reix <tony.reix@bull.net> - 6.1.0-5
- Remove everything dealing with AIX 5.*
- Put all 32bit & 64bit .so files in ..../libX.a file for X: atomic gcc_s gfortran gomp stdc++

* Mon May 30 2016 Tony Reix <tony.reix@bull.net> - 4.8.4-5
- Fix issues with Requires for libstdc++ and libstdc++-devel

* Wed May 11 2016 Tony Reix <tony.reix@bull.net> - 4.8.4-4
- Port on AIX 7.2
