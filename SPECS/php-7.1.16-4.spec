...
Patch3: %{name}-7.1.0-aix-trailing-slash.patch
# Automatically load OpenSSL configuration file
Patch4: %{name}-7.1.9-openssl-load-config.patch
...
# install the php-cgi binary. That fixes an issue in make install.
cp sapi/cgi/.libs/php-cgi ${RPM_BUILD_ROOT}%{_bindir}
chmod 755 ${RPM_BUILD_ROOT}%{_bindir}/php-cgi

# install the php binary. That fixes an issue in make install.
cp sapi/cli/.libs/php ${RPM_BUILD_ROOT}%{_bindir}
chmod 755 ${RPM_BUILD_ROOT}%{_bindir}/php
...
%changelog
* Wed Aug 08 2018 Sena Apeke <sena.apeke.external@atos.net> 7.1.16-4
- New release. Update to 7.1.16-4
-Enable ODBC for build-apache module

* Tue May 22 2018 Sena Apeke <sena.apeke.external@atos.net> 7.1.16-3
- New release. Update to 7.1.16-3
...
* Tue May 12 2017 Tony Reix <tony.reix@atos.net> 7.1.5-1
- New version.

* Tue May 11 2017 Tony Reix <tony.reix@atos.net> 7.1.4-1
- New version.
...
* Thu Jan 06 2017 Girardet Jean <jean.girardet@atos.net> 7.1.0-2
- build 64 bits version

* Tue Dec 22 2016 Matthieu Sarter <matthieu.sarter.external@atos.net> 7.1.0-1
