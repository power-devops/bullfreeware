...
Patch0:  %{name}-8.32-aix-uname.patch

# Avoid hardcoded path for libgmp.a
Patch1: %{name}-9.0-Makefile-replace-LIBGMP-by-LTLIBGMP.patch
...
%build
# setup environment for 64-bit builds
# 32bit is no longer build because of time_t not being 64bit.
# Coreutils' configure is refusing it.
...
# pthread is needed for some executables and tests but not added
# as default.
# TODO: a true patch
export LIBS=-pthread
...
%files
%defattr(-,root,system,-)
%doc COPYING ABOUT-NLS ChangeLog NEWS README THANKS TODO
...
%changelog
* Sat Oct 02 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 9.0-1
- Update to 9.0
- Remove 32bit version

* Fri Sep 18 2020 Clement Chigot <clement.chigot@atos.net> - 8.32-2
- Remove --disable-rpath option from configure

* Thu May 14 2020 Clement Chigot <clement.chigot@atos.net> - 8.32-1
