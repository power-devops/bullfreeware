...
# 64 bit
export CC="/opt/hamza/gcc-483-build-with-gas/bin/gcc"
export CXX="/opt/hamza/gcc-483-build-with-gas/bin/g++"
...
# 32 bit 
export CC="/opt/hamza/gcc-483-build-with-gas/bin/gcc -maix32"
export CXX="/opt/hamza/gcc-483-build-with-gas/bin/g++ -maix32"
...
${AR} -q src/.libs/libprotobuf-lite.a  src/.libs/libprotobuf-lite.so.8 src/.libs64/libprotobuf-lite.so.8
rm src/.libs/libprotobuf.a
${AR} -q src/.libs/libprotobuf.a  src/.libs/libprotobuf.so.8 src/.libs64/libprotobuf.so.8
rm src/.libs/libprotoc.a
${AR} -q src/.libs/libprotoc.a  src/.libs/libprotoc.so.8 src/.libs64/libprotoc.so.8
...
%{__ln_s} ../lib64/libprotobuf-lite.so.8 libprotobuf-lite.so
%{__ln_s} ../lib64/libprotobuf.so.8 libprotobuf.so
%{__ln_s} ../lib64/libprotoc.so.8 libprotoc.so
