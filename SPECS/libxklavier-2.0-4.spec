...
Patch0:		libxklavier-2.0-aix.patch
Patch1:		libxklavier-2.0-autotools.patch
...
$PATCH -p2 -s < %{_sourcedir}/libxklavier-2.0-aix.patch
$PATCH -p2 -s < %{_sourcedir}/libxklavier-2.0-autotools.patch
