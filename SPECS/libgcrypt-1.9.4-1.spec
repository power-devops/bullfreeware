...
Source0: https://gnupg.org/ftp/gcrypt/libgcrypt/libgcrypt-%{version}.tar.gz
...
Source4: libgcrypt-1.9.2-ecc-curves.c
Source5: libgcrypt-1.9.2-curves.c
Source6: libgcrypt-1.9.2-t-mpi-point.c
...
Patch18: libgcrypt-1.9.2-fips-ctor.patch
# Do not try to open /dev/urandom if getrandom() works
Patch24: libgcrypt-1.9.2-getrandom.patch
# Continuous FIPS entropy test
Patch26: libgcrypt-1.9.2-fips-enttest.patch 
# Disable non-approved FIPS hashes in the enforced FIPS mode
Patch27: libgcrypt-1.9.2-md-fips-enforce.patch
# FIPS module is redefined a little bit (implicit by kernel FIPS mode)
Patch30: libgcrypt-1.9.2-fips-module.patch
...
%changelog
* Sat Aug 28 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 1.9.4-1
- Update to 1.9.4

* Sat May 01 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 1.9.3-1
- Update to 1.9.3

* Mon Apr 19 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 1.9.2-1
- Update to 1.9.2

* Mon Apr 19 2021 Clement Chigot <clement.chigot@atos.net> - 1.8.7-1
