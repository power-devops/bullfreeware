...
# Provides for packages bundled by setuptools
#              Versions listed in setuptools/setuptools/_vendor/vendored.txt
...
Provides: python3-packaging = 16.8
Provides: python3-pyparsing = 2.2.1
Provides: python3-six = 1.10.0
...
# %patch0 -p1 -b .create-site-packages
...
#%py3_build_wheel
#%else
# /opt/freeware/bin/python3.6_32 setup.py build
#%endif
#%endif # with_python3
...
#%else
# /opt/freeware/bin/python3.6_32 setup.py install --skip-build --root ${RPM_BUILD_ROOT}
#%endif
#
...
#PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=$(pwd) py.test
