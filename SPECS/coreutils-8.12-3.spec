...
( cd $RPM_BUILD_ROOT
  ...
  # To assume to have no bad issues we conserve into usr/linux/bin repository
...
%changelog
* Thu Sep 22 2011 Patricia Cugny <patricia.cugny@bull.net> 8.12-3
- rebuild for compatibility with new libiconv.a 1.13.1-2
- remove link to tr command :
- incompatibility issue with tr -A called by rpm command  on AIX 6.1 and 7.1

* Mon Jun 06 2011 Gerard Visiedo <<gerard.visiedo@bull.net > 8.12-2
- Bug fixes
