...
# Fix procsubs.tests
#Patch905:   %{name}-5.1-tests-fix-procsubs-tests-on-OSes-using-named-pipes.patch
...
#Patch906:   %{name}-5.1-process-substitution-unlink-named-pipes-when-closing.patch
...
# Official upstream patches
%{lua:for i=1,4 do print(string.format("%%patch%u -p1\n", i, i)) end}
