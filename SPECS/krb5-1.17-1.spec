...
Patch103: %{name}-1.17-shopts-workaround.patch
...
#Patch1026: krb5-1.12.1-pamUPDATED2.patch
# Security Enhanced Linux
#Patch1027: krb5-1.17-beta1-selinux-label.patch

Patch1028: krb5-1.12-ksu-path.patch
Patch1029: krb5-1.12-ktany.patch
Patch1030: krb5-1.15-beta1-buildconf.patch

# Already applied (patch dates back to 2001) ?
#Patch1031: krb5-1.3.1-dns.patch
Patch1031: krb5-1.3.1-dnsUPDATED.patch

Patch1032: krb5-1.12-api.patch
Patch1033: krb5-1.13-dirsrv-accountlockUPDATED2.patch
Patch1034: krb5-1.9-debuginfo.patch

# Security Enhanced Linux
#Patch1035: krb5-1.11-run_user_0.patch

Patch1036: krb5-1.11-kpasswdtest.patch


# Some Fedora patches may touch same files, must apply most in following order


# Additional patches in Fedora 1.16.1-25 w.r.t. 1.16.1-2
# Includes migration to SHA-256 for audit ticket IDs and Python 3 for docs
# 8 patches with identical names applied to 1.17 are prefixed by ###
#         if the patch is modified, UPDATED is appended to the 1.17 name

#Patch1047: Fix-segfault-in-finish_dispatch.patch
#Patch1048: Log-when-non-root-ksu-authorization-fails.patch
#Patch1049: Add-k5_dir_filenames-to-libkrb5support.patch
#Patch1050: Process-profile-includedir-in-sorted-order.patch
#Patch1051: Make-docs-build-python3-compatible.patch
#Patch1052: Add-flag-to-disable-encrypted-timestamp-on-client.patch
#Patch1053: Explicitly-look-for-python2-in-configure.in.patch
#Patch1054: Use-SHA-256-instead-of-MD5-for-audit-ticket-IDs.patch
#Patch1055: Add-k5test-mark-function.patch
#Patch1056: Convert-Python-tests-to-Python-3.patch
#Patch1057: Zap-copy-of-secret-in-RC4-string-to-key.patch
#Patch1058: Fix-some-broken-tests-for-Python-3.patch
#Patch1059: Eliminate-preprocessor-disabled-dead-code.patch
#Patch1060: Make-krb5kdc-p-affect-TCP-ports.patch
#Patch1061: Remove-outdated-note-in-krb5kdc-man-page.patch
#Patch1062: Fix-k5test-prompts-for-Python-3.patch
###Patch1063: In-FIPS-mode-add-plaintext-fallback-for-RC4-usages-a.patch
#Patch1064: Remove-incorrect-KDC-assertion.patch
###Patch1065: Address-some-optimized-out-memset-calls.patch
###Patch1066: Avoid-allocating-a-register-in-zap-assembly.patch
###Patch1067: In-rd_req_dec-always-log-non-permitted-enctypes.patch
###Patch1068: In-kpropd-debug-log-proper-ticket-enctype-names.patch
###Patch1069: Add-function-and-enctype-flag-for-deprecations.patch
###Patch1070: Make-etype-names-in-KDC-logs-human-readable.patch
###Patch1071: Mark-deprecated-enctypes-when-used.patch

# 14 patches in Fedora 1.17-7 of which 8 are common with 1.16.1-25
# Patches  1090, 1093, 1100 - 1103 are specific to 1.17
# Patch    1089 has been modified for AIX (no AF_LOCAL)

Patch1089: In-FIPS-mode-add-plaintext-fallback-for-RC4-usages-aUPDATED.patch
Patch1090: Add-tests-for-KCM-ccache-type.patch
Patch1092: Address-some-optimized-out-memset-callsUPDATED.patch
Patch1093: Use-openssl-s-PRNG-in-FIPS-mode.patch
Patch1094: Avoid-allocating-a-register-in-zap-assemblyUPDATED.patch
Patch1095: In-rd_req_dec-always-log-non-permitted-enctypes.patch
Patch1096: In-kpropd-debug-log-proper-ticket-enctype-namesUPDATED.patch
Patch1097: Add-function-and-enctype-flag-for-deprecationsUPDATED.patch
Patch1098: Make-etype-names-in-KDC-logs-human-readable.patch
Patch1099: Mark-deprecated-enctypes-when-usedUPDATED.patch
Patch1100: Properly-size-ifdef-in-k5_cccol_lock.patch
Patch1101: Fix-memory-leak-in-none-replay-cache-type.patch
Patch1102: Become-FIPS-aware-with-3DES.patch
Patch1103: FIPS-aware-SPAKE-group-negotiation.patch
...
%patch1029 -p1 -b .krb5-1.12-ktany
%patch1030 -p1 -b .krb5-1.15-beta1-buildconf
%patch1031 -p1 -b .krb5-1.3.1-dnsUPDATED
...
%patch1089 -p1 -b .In-FIPS-mode-add-plaintext-fallback-for-RC4-usages-a
%patch1090 -p1 -b .Add-tests-for-KCM-ccache-type
%patch1092 -p1 -b .Address-some-optimized-out-memset-calls
%patch1093 -p1 -b .Use-openssl-s-PRNG-in-FIPS-mode
%patch1094 -p1 -b .Avoid-allocating-a-register-in-zap-assembly
%patch1095 -p1 -b .In-rd_req_dec-always-log-non-permitted-enctypes
%patch1096 -p1 -b .In-kpropd-debug-log-proper-ticket-enctype-names
%patch1097 -p1 -b .Add-function-and-enctype-flag-for-deprecations
%patch1098 -p1 -b .Make-etype-names-in-KDC-logs-human-readable
%patch1099 -p1 -b .Mark-deprecated-enctypes-when-used
%patch1100 -p1 -b .Properly-size-ifdef-in-k5_cccol_lock
%patch1101 -p1 -b .Fix-memory-leak-in-none-replay-cache-type
%patch1102 -p1 -b .Become-FIPS-aware-with-3DES
%patch1103 -p1 -b .FIPS-aware-SPAKE-group-negotiation
