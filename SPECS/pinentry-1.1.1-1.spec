...
%if %{with gtk}
Patch12:  %{name}-%{version}-aix-gtk.patch
%endif
Patch13:  %{name}-%{version}-aix-Makefile.in.patch
%define Patch2Useful 0
Patch2:  %{name}-%{version}-gdkkeysyms.h.patch

# From Fedora v1.1.1
Patch3: pinentry-1.1.1-coverity.patch
Patch4: pinentry-1.1.1-rpath.patch
