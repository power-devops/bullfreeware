...
Source0:    https://github.com/Kitware/CMake/releases/download/v3.16.0/%{name}-%{version}.tar.gz
Source1000: %{name}-%{version}-%{release}.build.log

Patch1:         cmake-3.16.0_NewAIXbehavior.patch
Patch2:         cmake-3.16.0_NewAIXbehavior_tests.patch
