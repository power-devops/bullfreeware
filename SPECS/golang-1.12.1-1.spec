...
Patch23:     go-1.12-cmd-link-support-dwarf64-when-writing-debug_frame-20190306.patch
Patch24:     go-1.12-syscall-add-missing-Setrlimit-and-Termios-on-aix-ppc-20190227.patch
Patch25:     go-1.12-archive-syscall-add-statunix-for-aix-ppc64-20190228.patch
Patch27:     go-1.12-cmd-link-fix-a-with-external-linker-20190227.patch
Patch28:     go-1.12-cmd-go-fix-Wl-whole-archive-for-aix-ppc64-20190227.patch
Patch29:     go-1.12-cmd-go-pass-X64-to-ar-on-aix-ppc64-20190306.patch
Patch30:     go-1.12-syscall-add-Chroot-and-Dup2-for-aix-ppc64-20190313.patch
Patch31:     go-1.12-net-fix-fd-leak-with-interfaces-on-aix-ppc64-20190305.patch
Patch32:     go-1.12-runtime-disable-TestGdbAutotmpTypes-in-short-mode-on-20190306.patch

# CGO
Patch13:     go-1.12-cmd-runtime-fix-C-trampolines-on-aix-ppc64-20190226.patch
Patch14:     go-1.12-net-os-user-allow-build-on-aix-ppc64-with-cgo-20190226.patch
Patch15:     go-1.12-runtime-fix-TestSigStackSwapping-on-aix-ppc64-20190226.patch
Patch16:     go-1.12-runtime-disable-pprof-test-with-cgo-on-aix-ppc64-20190315.patch
Patch17:     go-1.12-cmd-dist-runtime-enable-external-linker-tests-for-ai-20190226.patch
Patch18:     go-1.12-runtime-fix-sigfwd-for-aix-ppc64-20190226.patch
Patch19:     go-1.12-cmd-internal-goobj-fix-TestParseCGOArchive-for-aix-p-20190226.patch
Patch20:     go-1.12-cmd-nm-fix-cgo-tests-for-aix-ppc64-20190226.patch
Patch21:     go-1.12-cmd-dist-misc-cgo-enable-tests-for-aix-ppc64-20190226.patch
Patch22:     go-1.12-cmd-dist-enable-cgo-for-aix-ppc64-20190226.patch

# Others patches
Patch26:     go-1.12-runtime-perform-atomic-Load-on-sched-values-20190226.patch
Patch33:     go-1.12-cmd-compile-misc-cgo-fix-fortran-tests-on-aix-ppc64-20190306.patch

Source100:      golang-gdbinit

%description
The Go Programming Language source tree v1.12.1 for AIX 7.2 / Power >= 8.
A beta of cgo and external linking is available. Patches will be updated time to time according to community reviews.
Some features are not yet available: pprof, race detector.
...
if ls -l %{_bindir}/go 2>/dev/null | grep -q '.golang'; then
	rm %{_bindir}/go
fi
if ls -l %{_bindir}/gofmt 2>/dev/null | grep -q '.golang'; then
	rm %{_bindir}/gofmt
fi
