...
Source0: http://download.gnome.org/sources/glib/2.33/glib-%{version}.tar.bz2
Patch0:  glib-%{version}-aix.patch
Patch1:  glib-%{version}-aix_platform.patch
Patch2:  glib-%{version}-aix_xlc_issue.patch
BuildRoot: /var/tmp/glib-%{version}-buildroot
...
%patch0 -p1 -b .aix
%patch1 -p1 -b .aix_platform
%patch2 -p1 -b .aix_xlc_issue

sed -e "s;rm -r xdgdatahome;rm -fr xdgdatahome;" \
   $RPM_BUILD_DIR/glib-%{version}/gio/tests/Makefile.in \
   > $RPM_BUILD_DIR/glib-%{version}/gio/tests/Makefile.in.tmp
cp -f $RPM_BUILD_DIR/glib-%{version}/gio/tests/Makefile.in.tmp \
   $RPM_BUILD_DIR/glib-%{version}/gio/tests/Makefile.in
...
CFLAGS="-D_LARGE_FILES -D_LARGEFILE_SOURCE -I/opt/freeware/include -I/usr/include -g"  LIBS=' -L/opt/freeware/lib' \
CPPFLAGS="-D_LARGE_FILES -D_LARGEFILE_SOURCE -I/opt/freeware/include -I/usr/include -g"  LIBS=' -L/opt/freeware/lib' \
...
%changelog
* Fri Oct 11 2013 Gerard Visiedo <gerard.visiedo@bull.net> 2.31.2-1
- Build version 2.31 for gtk2-2.20.1 compatibility
