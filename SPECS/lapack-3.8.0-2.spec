...
%global	_cel_path	/opt/IBM/xlc/13.1.3/bin/
...
export XLF="/opt/freeware/bin/gfortran  -O2 -maix64"
export F77="/opt/freeware/bin/gfortran  -O2 -maix64"
...
if [ "%{dotests}" == 1 ]
then
gmake blas_testing lapack_testing
fi

%{_cel_path}/CreateExportList -X64 refblas.exp librefblas.a
${CC} -shared librefblas.a  -o libblas.so.3 -lgfortran -lm -Wl,-bE:refblas.exp -Wl,-berok -Wl,-blibpath:/opt/freeware/lib64:/opt/freeware/lib:/usr/lib:/lib
rm -f refblas.exp librefblas.a
${AR} -rv libblas.a libblas.so.3

%{_cel_path}/CreateExportList -X64 lapack.exp liblapack.a
${CC} -shared liblapack.a -o liblapack.so.3 -lgfortran -lm -L. -lblas -Wl,-bE:lapack.exp -Wl,-berok -Wl,-blibpath:/opt/freeware/lib64:/opt/freeware/lib:/usr/lib:/lib
rm -f lapack.exp liblapack.a
${AR} -rv liblapack.a liblapack.so.3

%{_cel_path}/CreateExportList -X64 lapacke.exp liblapacke.a
${CC} -shared liblapacke.a -o liblapacke.so.3 -lgfortran -lm -L. -llapack -Wl,-bE:lapacke.exp -Wl,-berok -Wl,-blibpath:/opt/freeware/lib64:/opt/freeware/lib:/usr/lib:/lib
rm -f lapacke.exp liblapacke.a
${AR} -rv liblapacke.a liblapacke.so.3
...
export XLF="/opt/freeware/bin/gfortran  -O2 -maix32 -D_LARGE_FILES"
export F77="/opt/freeware/bin/gfortran  -O2 -maix32 -D_LARGE_FILES"
...
%{_cel_path}/CreateExportList -X32 refblas.exp librefblas.a
${CC} -shared librefblas.a  -o libblas.so.3 -lgfortran -lm -Wl,-bE:refblas.exp -Wl,-berok -Wl,-bmaxdata:0x80000000 -Wl,-blibpath:/opt/freeware/lib:/usr/lib:/lib
rm -f refblas.exp librefblas.a
${AR} -rv libblas.a libblas.so.3

%{_cel_path}/CreateExportList -X32 lapack.exp liblapack.a
${CC} -shared liblapack.a -o liblapack.so.3 -lgfortran -lm -L. -lblas -Wl,-bE:lapack.exp -Wl,-berok -Wl,-bmaxdata:0x80000000 -Wl,-blibpath:/opt/freeware/lib:/usr/lib:/lib
rm -f lapack.exp liblapack.a
${AR} -rv liblapack.a liblapack.so.3

%{_cel_path}/CreateExportList -X32 lapacke.exp liblapacke.a
${CC} -shared liblapacke.a -o liblapacke.so.3 -lgfortran -lm -L. -llapack -Wl,-bE:lapacke.exp -Wl,-berok -Wl,-bmaxdata:0x80000000 -Wl,-blibpath:/opt/freeware/lib:/usr/lib:/lib
rm -f lapacke.exp liblapacke.a
${AR} -rv liblapacke.a liblapacke.so.3
...
for f in lapack lapacke blas; do
     /usr/bin/ar -X64 -q lib${f}.a ../64bit/lib${f}.so.3
done
...
(
  ...
  for f in libblas.a liblapack.a liblapacke.a
  do
    ln -s ../lib/${f} ${f}
  done
)
...
for f in libblas.a liblapack.a liblapacke.a ; do
