...
%define major_version 8.0
%define minor_version 11

%define _libdir64 %{_prefix}/lib64
%define phplibdir   %{_libdir}/php%{major_version}
%define phplib64dir %{_libdir64}/php%{major_version}
%define phpconfigdir %{_sysconfdir}/php%{major_version}.d
...
%setup -n php-%{major_version}.%{minor_version} -q
...
# Move devel files
mv ${RPM_BUILD_ROOT}%{_includedir}/php ${RPM_BUILD_ROOT}%{_includedir}/php%{major_version}
...
%files cli
%defattr(-,root,system)
%{_bindir}/php%{major_version}
%{_bindir}/php%{major_version}_32
%{_bindir}/php%{major_version}_64
%{_bindir}/php-cgi%{major_version}*
%{_bindir}/phar%{major_version}*
%{_bindir}/phpize%{major_version}*
%{_mandir}/man1/php%{major_version}.1*
%{_mandir}/man1/php-cgi%{major_version}.1*
%{_mandir}/man1/phar%{major_version}*.1*
%{_mandir}/man1/phpize%{major_version}.1*

%files devel
%defattr(-,root,system)
%dir %{phplibdir}
%dir %{phplib64dir}
%{_bindir}/php-config%{major_version}*
%{_includedir}/php%{major_version}
%{phplibdir}/build
%{phplib64dir}/build
%{_mandir}/man1/php-config%{major_version}.1

%files dbg
%defattr(-,root,system,-)
%doc 32bit/sapi/phpdbg/CREDITS*
%{_bindir}/phpdbg%{major_version}*
%{_mandir}/man1/phpdbg%{major_version}.1*
