...
# CGO
Patch3:      go-1.12-runtime-fix-call-of-asmsyscall6-on-aix-ppc64-20190226.patch
Patch4:      go-1.12-runtime-handle-syscalls-without-g-or-m-for-aix-ppc64-20190226.patch
Patch5:      go-1.12-runtime-cgo-add-port-for-aix-ppc64-20190226.patch
Patch6:      go-1.12-cmd-link-runtime-allow-external-linking-for-aix-ppc6-20190228.patch
Patch7:      go-1.12-cmd-link-fix-moduledata-symbols-for-aix-ppc64-and-ex-20190226.patch
Patch8:      go-1.12-cmd-link-fix-cgo_export-for-aix-ppc64-20190228.patch
Patch9:      go-1.12-cmd-link-enable-DWARF-with-external-linker-on-aix-pp-20190226.patch
Patch10:     go-1.12-cmd-disable-DWARF-with-old-ld-on-aix-ppc64-20190226.patch
Patch11:     go-1.12-cmd-always-allow-bigtoc-generation-with-gcc-on-aix-p-20190226.patch
Patch12:     go-1.12-cmd-link-fix-trampoline-generation-for-aix-ppc64-20190226.patch
...
Patch16:     go-1.12-runtime-disable-pprof-test-with-cgo-on-aix-ppc64-20190226.patch
...
# Others patches
Patch23:     go-1.12-cmd-link-fix-debug_frame-generation-for-Dwarf64-20190226.patch
Patch26:     go-1.12-runtime-perform-atomic-Load-on-sched-values-20190226.patch
Patch29:     go-1.12-cmd-go-fix-ar-call-on-aix-ppc64-20190228.patch
Patch30:     go-1.12-syscall-add-Chroot-syscall-for-aix-ppc64-20190228.patch
Patch31:     go-1.12-net-fix-fd-leak-with-interfaces-on-aix-ppc64-20190305.patch

Source100:      golang-gdbinit

%description
The Go Programming Language source tree v1.12 for AIX 7.2 / Power >= 8.
...
ln -sn %{goroot}/bin/go $RPM_BUILD_ROOT%{_bindir}/go.golang
rm -f $RPM_BUILD_ROOT%{_bindir}/gofmt
ln -sn %{goroot}/bin/gofmt $RPM_BUILD_ROOT%{_bindir}/gofmt.golang
