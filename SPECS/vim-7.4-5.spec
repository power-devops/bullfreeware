# TODO
# Have a look of to many patches
# Use python3
# Check !
# X version uses gtk2 (7 years old), erase it?
# Compile on 64 bits only
...
Patch5001: vim-7.4-rclocation.patch


BuildRequires: python >= 2.7.17-2, gettext-devel, perl(perl) >= 5.30
...
export CC="/opt/freeware/bin/gcc -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_LARGE_FILES"
...
LIBS=" -L/opt/freeware/lib -L/usr/lib" gmake --trace VIMRCLOC=%{_sysconfdir} VIMRUNTIMEDIR=%{_datadir}/%{name}/%{vimdir}
