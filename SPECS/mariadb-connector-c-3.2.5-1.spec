...
Patch10:      mariadb-connector-c-3.1.12-compat.patch
...
# If you want to check mariadb-connector-c, 
# mariadb-server must be installed and must run during build.
...
%changelog
* Mon Nov 15 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 3.2.5-1
- Update to 3.2.5

* Mon Nov 15 2021 Etienne Guesnet <etienne.guesnet@atos.net> - 3.2.4-2
- Remove env

* Sat Aug 14 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 3.2.4-1
- Update to 3.2.4

* Sat Jul 31 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 3.2.3-1
- Update to 3.2.3

* Thu Jul 29 2021 Etienne Guesnet <etienne.guesnet@atos.net> - 3.1.13-2
- Change flags for compatibility with CMake 3.20.

* Tue Jul 27 2021 Etienne Guesnet <etienne.guesnet@atos.net> - 3.1.13-1
- New version 3.1.13

* Mon Mar 01 2021 Étienne Guesnet <etienne.guesnet@atos.net> - 3.1.12-1
- New version 3.1.12
- Remove lot of patches (integrated upstream)
