...
Name:             mariadb
Version:          10.3.10
Release:          1beta%{?with_debug:.debug}%{?dist}
Epoch:            3
...
Patch10:        mariadb-10.3.10_gssapi.patch
Patch11:        mariadb-10.3.10_large_file.patch
Patch12:        mariadb-10.3.10_priu64.patch
Patch13:        mariadb-10.3.10_raw1.patch
Patch14:        mariadb-10.3.10_raw2.patch
Patch15:        mariadb-10.3.10_mmap64.patch
Patch16:        mariadb-10.3.10_raw3.patch
Patch17:        mariadb-10.3.10_raw4.patch
Patch18:        mariadb-10.3.10_int8.patch
Patch19:        mariadb-10.3.10_dontwait.patch
Patch20:        mariadb-10.3.10_getopt1.patch
Patch21:        mariadb-10.3.10_getopt2.patch
...
BuildRequires:    bison
BuildRequires:    gnutls gnutls-devel
...
BE CAREFUL :
This version is a beta one. Only .so files are delivered without lib*.a
BE CAREFUL :
...
export LDFLAGS="-Wl,-blibpath:/opt/freeware/lib:/opt/freeware/lib64:/usr/lib:/lib -lpgport"
CFLAGS="%{optflags} -L/opt/freeware/lib64 -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -maix64 -Wl,-bbigtoc"
...
CXXFLAGS="$CFLAGS"
export CC64=" ${CC__}  ${CFLAGS}"
export CXX64="${CXX__} ${CXXFLAGS}"
...
export LIBPATH=/opt/freeware/lib/gcc/powerpc-ibm-aix7.2.0.0/8.2.0/pthread:$LIBPATH
...
%cmake . \
	 ...
	 -DOPENSSL_LIBRARIES=/opt/freeware/lib \
	 -DOPENSSL_ROOT_DIR=/usr/bin \
...
# install Docs/INFO_SRC %{buildroot}%{_libdir}/%{pkg_name}/
# install Docs/INFO_BIN %{buildroot}%{_libdir}/%{pkg_name}/
...
perl -pi -e 's|^wsrep_provider=none|wsrep_provider=%{_libdir}/galera/libgalera_smm.so|' support-files/wsrep.cnf
