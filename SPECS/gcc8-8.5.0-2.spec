...
Patch20: gcc-8.4.0-aix-Fix-_STDC_FORMAT_MACROS-in-inttypes.h.patch

# Add libstdc++ locale support
Patch21: gcc-8.4.0-libstdc-implement-locale-support-for-XPG7.patch

# Fix 64bit inodes with stat
Patch22: gcc-8.4.0-aix-handle-64bit-inodes-for-include-directories.patch
...
# libgo multilib tests have been already launched by the previous
# "gmake check"
...
%changelog
* Thu Jul 29 2021 Clement Chigot <clement.chigot@atos.net> - gcc8-8.5.0-2
- Add bash as requires(post) for mkheaders


* Mon May 17 2021 Clement Chigot <clement.chigot@atos.net> - gcc8-8.5.0-1
- Update to version 8.5.0
- Improves %post regeneration of includes by calling mkheaders directly
- Remove configure option --enable-decimal-float=dpd and --enable__cxa_atexit
- Fix collect2 with archives containing text files

* Tue May 11 2021 Clement Chigot <clement.chigot@atos.net> - gcc8-8.4.0-7
...
* Tue Jan 05 2021 Clement Chigot <clement.chigot@atos.net> - gcc8-8.4.0-6
- Remove cgo tests duplication
...
* Thu Sep 17 2020 Clement Chigot <clement.chigot@atos.net> - gcc8-8.4.0-5
