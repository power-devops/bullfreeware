...
cp 32bit/libtool ${RPM_BUILD_ROOT}%{_bindir}/libtool.gcc.32
cp 64bit/libtool ${RPM_BUILD_ROOT}%{_bindir}/libtool.gcc.64
...
sed -e "s/\/home2\/freeware/\/opt\/freeware/g" -i ${RPM_BUILD_ROOT}%{_bindir}/libtool.gcc.32
sed -e "s/\/home2\/freeware/\/opt\/freeware/g" -i ${RPM_BUILD_ROOT}%{_bindir}/libtool.gcc.64
