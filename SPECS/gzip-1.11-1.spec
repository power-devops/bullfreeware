...
%post
/sbin/install-info %{_infodir}/gzip.info.gz || :
...
%preun
if [ $1 = 0 ]; then
    /sbin/install-info --delete %{_infodir}/gzip.info.gz || :
fi
...
%changelog
* Sat Sep 04 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 1.11-1
- Update to 1.11

* Tue Jun 08 2021 Tony Reix <tony.reix@atos.net> - 1.10-3
