...
#  BuildRequires guile < 2 seems still required, since with guile v2.0.11 I got:
...
%changelog
* Thu Sep 08 2016 Tony Reix - <tony.reix@atos.net> - 5.12-3
- Remove version < 2 for Requires on guile
  BuildRequires guile < 2 seems still required
  Since missing compatibility files have been added into guile 2.0.11-3
- Add build.log file to .src.rpm
