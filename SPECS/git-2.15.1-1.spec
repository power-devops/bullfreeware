...
Patch1:		%{name}-2.12.0-mk-aix.patch
Patch2:		%{name}-2.12.0-aix.patch
...
export LDFLAGS="-L/opt/freeware/lib  -Wl,-blibpath:/opt/freeware/lib:/usr/lib:/l
ib"
...
mv ${RPM_BUILD_ROOT}/Error.pm ${RPM_BUILD_ROOT}%{_libdir}64/perl5/%{perl_version}
mv ${RPM_BUILD_ROOT}/Git ${RPM_BUILD_ROOT}%{_libdir64}/perl5/%{perl_version}
...
%changelog
* Fri Jan 12 2018 Daniele Silvestre <daniele.silvestre@atos.net>
