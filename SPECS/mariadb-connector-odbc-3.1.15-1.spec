...
Group:      Servers
License:    LGPLv2+
Source:     https://downloads.mariadb.com/Connectors/odbc/connector-odbc-%{version}/mariadb-connector-odbc-%{version}-src.tar.gz
...
export MAKE="gmake %{?_smp_mflags:-j%_smp_mflags}"
...
%changelog
* Sat Nov 20 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 3.1.15-1
- Update to 3.1.15

* Tue Nov 02 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 3.1.14-1
- Update to 3.1.14

* Tue Nov 02 2021 Clément Chigot <clement.chigot@atos.net> - 3.1.13-2
- Remove "env" calls

* Tue Jul 27 2021 Etienne Guesnet <etienne.guesnet.@atos.net> - 3.1.13-1
- New version 3.1.13
- All paatches are integrated upstream

* Tue Mar 02 2021 Étienne Guesnet <etienne.guesnet.@atos.net> - 3.1.11-1
- New version 3.1.11

* Mon Jul 20 2020 �~Itienne Guesnet <etienne.guesnet.external@atos.net> - 3.1.9-1
- New version 3.1.9
