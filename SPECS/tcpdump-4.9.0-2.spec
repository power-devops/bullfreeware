...
export LDFLAGS="-L/opt/freeware/lib64 -L/opt/freeware/lib -Wl,-blibpath:/opt/freeware/lib64:/opt/freeware/lib:/usr/lib"
...
%changelog
* Wed Sep 20 2017 Pascal Oliva < pascal.oliva@atos.net> - 4.9.0-2
- Remove  -bmaxdata:0x80000000 build option on 64bit mode
