...
# GCC is v10 by default, now. To be changed when needed
%global GCC_Version 10
...
Source0: https://sourceforge.net/projects/boost/files/%{name}/%{version}/%{toplev_dirname}.tar.bz2
...
%if %{with python3}
%package -n python3-boost-numpy
Summary: Run-time component of boost numpy library for Python 3
Requires: python%{python_version}-boost-numpy = %{version}-%{release}
Requires: python3-boost = %{version}-%{release}
Requires: python3-numpy

%description -n python3-boost-numpy
...
%package -n python%{python_version}-boost-numpy
Summary: Run-time component of boost numpy library for Python 3
Requires: python%{python_version}-boost = %{version}-%{release}
Requires: python%{python_version}-numpy
 
%description -n python%{python_version}-boost-numpy
The Boost Python Library is a framework for interfacing Python and
C++. It allows you to quickly and seamlessly expose C++ classes,
functions and objects to Python, and vice versa, using no special
tools -- just your C++ compiler.  This package contains run-time
...
%package -n python3-boost-devel
Summary: Shared object symbolic links for Boost.Python 3
Requires: python(abi) = %{python_version}
Requires: python3-boost = %{version}-%{release}
Requires: python3-boost-numpy = %{version}-%{release}
Requires: python%{python_version}-boost-devel = %{version}-%{release}

%description -n python3-boost-devel
Shared object symbolic links for Python 3 variant of Boost.Python.

%package -n python%{python_version}-boost
Summary: Run-time component of boost python library for Python 3
Requires: python%{python_version}(abi) = %{python_version}

%description -n python%{python_version}-boost
The Boost Python Library is a framework for interfacing Python and
C++. It allows you to quickly and seamlessly expose C++ classes,
functions and objects to Python, and vice versa, using no special
tools -- just your C++ compiler.  This package contains run-time
...
%package -n python%{python_version}-boost-devel
Summary: Shared object symbolic links for Boost.Python 3
Requires: python%{python_version}(abi) = %{python_version}
Requires: python%{python_version}-boost = %{version}-%{release}
Requires: python%{python_version}-boost-numpy = %{version}-%{release}

%description -n python%{python_version}-boost-devel
Shared object symbolic links for Python 3 variant of Boost.Python.
%endif
...
%if %{with python3}
%package -n python3-boost-openmpi
...
Requires: python%{python_version}-boost-openmpi

%description -n python3-boost-openmpi
Python 3 support for Boost.MPI-OpenMPI, a library providing a clean C++
API over the OpenMPI implementation of MPI.

%package -n python3-boost-openmpi-devel
Summary: Shared library symbolic links for Boost.MPI Python 3 component
Requires: %{name}-devel = %{version}-%{release}
Requires: python3-boost-devel = %{version}-%{release}
Requires: %{name}-openmpi-devel = %{version}-%{release}
Requires: python3-%{name}-openmpi = %{version}-%{release}
Requires: python%{python_version}-boost-openmpi-devel

%description -n python3-boost-openmpi-devel
...
%package -n python%{python_version}-boost-openmpi
Summary: Python 3 run-time component of Boost.MPI library
Requires: %{name}-openmpi%{?_isa} = %{version}-%{release}
Requires: python%{python_version}-boost = %{version}-%{release}
Requires: %{name}-serialization%{?_isa} = %{version}-%{release}
Requires: python%{python_version}-openmpi%{?_isa}

%description -n python%{python_version}-boost-openmpi
Python 3 support for Boost.MPI-OpenMPI, a library providing a clean C++
API over the OpenMPI implementation of MPI.

%package -n python%{python_version}-boost-openmpi-devel
Summary: Shared library symbolic links for Boost.MPI Python 3 component
Requires: %{name}-devel%{?_isa} = %{version}-%{release}
Requires: python%{python_version}-%{name}-devel = %{version}-%{release}
Requires: %{name}-openmpi-devel%{?_isa} = %{version}-%{release}
Requires: python%{python_version}-%{name}-openmpi = %{version}-%{release}

%description -n python%{python_version}-boost-openmpi-devel
Devel package for the Python 3 interface of Boost.MPI-OpenMPI, a library
providing a clean C++ API over the OpenMPI implementation of MPI.
%endif
...
Requires: python%{python_version}-boost-mpich  = %{version}-%{release}

%description -n python3-boost-mpich
Python 3 support for Boost.MPI-MPICH, a library providing a clean C++
API over the MPICH implementation of MPI.

%package -n python3-boost-mpich-devel
Summary: Shared library symbolic links for Boost.MPI Python 3 component
Requires: python(abi) = %{python_version}
Requires: %{name}-devel = %{version}-%{release}
Requires: python3-boost-devel = %{version}-%{release}
Requires: %{name}-mpich-devel = %{version}-%{release}
Requires: python3-%{name}-mpich = %{version}-%{release}
Requires: python%{python_version}-boost-mpich-devel  = %{version}-%{release}

%description -n python3-boost-mpich-devel
...
%package -n python%{python_version}-boost-mpich
Summary: Python 3 run-time component of Boost.MPI library
Requires: python%{python_version}(abi)
Requires: %{name}-mpich%{?_isa} = %{version}-%{release}
Requires: python%{python_version}-boost = %{version}-%{release}
Requires: %{name}-serialization%{?_isa} = %{version}-%{release}
Requires: python%{python_version}-mpich%{?_isa}

%description -n python%{python_version}-boost-mpich
Python 3 support for Boost.MPI-MPICH, a library providing a clean C++
API over the MPICH implementation of MPI.

%package -n python%{python_version}-boost-mpich-devel
Summary: Shared library symbolic links for Boost.MPI Python 3 component
Requires: python%{python_version}(abi)
Requires: %{name}-devel%{?_isa} = %{version}-%{release}
Requires: python%{python_version}-boost-devel%{?_isa} = %{version}-%{release}
Requires: %{name}-mpich-devel%{?_isa} = %{version}-%{release}
Requires: python%{python_version}-%{name}-mpich = %{version}-%{release}

%description -n python%{python_version}-boost-mpich-devel
Devel package for the Python 3 interface of Boost.MPI-MPICH, a library
providing a clean C++ API over the MPICH implementation of MPI.
%endif
...
%if %{with python3}
# Should be empty now
PYTHON3_ABIFLAGS=$(/opt/freeware/bin/python%{python_version}-config --abiflags)
...
cat >> python3-config.jam << EOF
using python : %{python_version} : /usr/bin/python3 : /usr/include/python%{python_version}${PYTHON3_ABIFLAGS} : : : : ${PYTHON3_ABIFLAGS} ;
EOF
...
mkdir -p ${RPM_BUILD_ROOT}%{python_sitearch64}/openmpi/boost
touch ${RPM_BUILD_ROOT}%{python_sitearch64}/openmpi/boost/__init__.py
mv ${RPM_BUILD_ROOT}${MPI_HOME}/lib/mpi.so \
   ${RPM_BUILD_ROOT}%{python_sitearch64}/openmpi/boost/
%endif
...
# Move Python module to proper location for automatic loading
mkdir -p ${RPM_BUILD_ROOT}%{python_sitearch64}/mpich/boost
touch ${RPM_BUILD_ROOT}%{python_sitearch64}/mpich/boost/__init__.py
mv ${RPM_BUILD_ROOT}${MPI_HOME}/lib/mpi.so \
   ${RPM_BUILD_ROOT}%{python_sitearch64}/mpich/boost/
%endif
...
%if %{with python3}
%files -n python%{python_version}-boost-numpy
%defattr(-,root,system,-)
%license LICENSE_1_0.txt
#%%{_libdir}/libboost_numpy%{__python_nodot_version}.a*
%{_libdir64}/libboost_numpy%{__python_nodot_version}.a*

%files -n python3-boost-numpy
%defattr(-,root,system,-)
%endif
...
%if %{with python3}
%files -n python%{python_version}-boost
%defattr(-,root,system,-)
%license LICENSE_1_0.txt
#%%{_libdir}/libboost_python%{__python_nodot_version}.a*
%{_libdir64}/libboost_python%{__python_nodot_version}.a*

%files -n python%{python_version}-boost-devel
%defattr(-,root,system,-)
%license LICENSE_1_0.txt
...
%if %{with python3}
%files -n python%{python_version}-boost-openmpi
%defattr(-,root,system,-)
%license LICENSE_1_0.txt
#%%{_libdir}/openmpi/lib/libboost_mpi_python%%{__python_nodot_version}.a*
%{_libdir64}/openmpi/lib/libboost_mpi_python%{__python_nodot_version}.a*
%{python_sitearch64}/openmpi/boost/

%files -n python%{python_version}-boost-openmpi-devel
%defattr(-,root,system,-)
%license LICENSE_1_0.txt
#%%{_libdir}/openmpi/lib/libboost_mpi_python%%{__python_nodot_version}.a*
%{_libdir64}/openmpi/lib/libboost_mpi_python%{__python_nodot_version}.a*

%files -n python3-boost-openmpi
%defattr(-,root,system,-)

%files -n python3-boost-openmpi-devel
%defattr(-,root,system,-)
%endif
...
%if %{with python3}
%files -n python%{python_version}-boost-mpich
%defattr(-,root,system,-)
%license LICENSE_1_0.txt
#%%{_libdir}/mpich/lib/libboost_mpi_python%%{__python_nodot_version}.a*
%{_libdir64}/mpich/lib/libboost_mpi_python%{__python_nodot_version}.a*
%{python_sitearch64}/mpich/boost/

%files -n python%{python_version}-boost-mpich-devel
%defattr(-,root,system,-)
%license LICENSE_1_0.txt
#%%{_libdir}/mpich/lib/libboost_mpi_python%%{__python_nodot_version}.a*
%{_libdir64}/mpich/lib/libboost_mpi_python%{__python_nodot_version}.a*

%files -n python3-boost-mpich
%defattr(-,root,system,-)

%files -n python3-boost-mpich-devel
%defattr(-,root,system,-)
%endif
...
%changelog
* Tue Nov 30 2021 Etienne Guesnet <etienne.guesnet@atos.net> - 1.73.0-3
- Add python metapackage
- Remove support of 32 bits for python
