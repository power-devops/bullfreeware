...
%files
%defattr(-,root,system)
%doc INSTALL INSTALL.configure MANIFEST NEWS README README.LDAP
...
%{_datadir}/doc/sudo/CONTRIBUTORS
%{_datadir}/doc/sudo/ChangeLog
%{_datadir}/doc/sudo/HISTORY
%{_datadir}/doc/sudo/LICENSE
%{_datadir}/doc/sudo/NEWS
%{_datadir}/doc/sudo/TROUBLESHOOTING
%{_datadir}/doc/sudo/UPGRADE
%{_datadir}/doc/sudo/sample*
%{_includedir}/*
/usr/include/*

%changelog
* Fri Sep 13 2013 Gerard Visiedo <gerard.visiedo@bull.net> 1.8.7-1
