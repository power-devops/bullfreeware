...
BuildRequires:  python-devel >= 2.7.13
...
/opt/freeware/bin/python setup.py build
...
/opt/freeware/bin/python setup.py install \
    --root=${RPM_BUILD_ROOT} \
...
%changelog
* Wed Dec 04 2019 Clément Chigot <clement.chigot@atos.net> - 3.0.5-2
- Remove /usr/bin/python dependency
- Remove /usr links

* Tue Apr 23 2019 Tony Reix <tony.reix@bull.net> - 3.0.5-1
- Initial port on AIX 6.1

* Tue Apr 23 2019 Tony Reix <tony.reix@bull.net> - 3.0.1-1
- Initial port on AIX 6.1
