...
Patch1:         cmake-3.22.1-2_NewAIXbehavior.patch
...
# Do not bootstrap CMake if is not needed.
# This reduces time needed and permit to control libpath.
cmake . \
  -DCMAKE_INSTALL_RPATH=$LIBPATH          \
  -DCMAKE_BUILD_RPATH=$LIBPATH            \
  ...
  -DCMAKE_USE_SYSTEM_JSONCPP:BOOL=OFF   \
  -DCMAKE_USE_SYSTEM_KWIML:BOOL=OFF     \
  -DCMAKE_USE_SYSTEM_LIBARCHIVE:BOOL=ON \
  -DCMAKE_USE_SYSTEM_LIBLZMA:BOOL=ON    \
  -DCMAKE_USE_SYSTEM_LIBRHASH:BOOL=OFF  \
  -DCMAKE_USE_SYSTEM_LIBUV:BOOL=OFF     \
...
%changelog
* Wed Feb 9 2022  Etienne Guesnet <etienne.guesnet@atos.net> - 3.22.1-2
- Use system library by avoiding bootstrap
- Add the right libpath to cmake
- Add BuildRequires due to system library used
- Activate ccmake

* Sat Dec 11 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 3.22.1-1
- Update to 3.22.1

* Wed Nov 03 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 3.21.4-1
- Update to 3.21.4

* Tue Nov 02 2021 Clément Chigot <clement.chigot@atos.net> - 3.21.3-2
- Remove "env" calls

* Sat Oct 02 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 3.21.3-1
- Update to 3.21.3
