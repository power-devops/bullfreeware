...
%define __python3 /opt/freeware/bin/python3
...
This version adds partial support on AIX.

# In version 0.59.0, checksum error with AIX tar.
...
install -Dpm0644 -t ${RPM_BUILD_ROOT}%{rpmmacrodir} data/macros.%{name}
...
# The cmake tests might freeze sometimes, due to yet unknown reasons. 
%{__python3} ./run_tests.py || true
...
%changelog
* Mon Sep 06 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 0.59.1-1
- Update to 0.59.1

* Tue Aug 10 2021 Clement Chigot <clement.chigot@atos.net> - 0.59.0-1
- Update to version 0.59.0
- BullFreeware Compatibility Improvements

* Tue Jan 07 2020 Sangamesh Mallayya <smallayy@in.ibm.com> - 0.52.1-1
