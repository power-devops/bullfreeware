...
Patch0:   %{name}-4.4.0.socket.patch
Patch1:   %{name}-4.4.0.accept-int.patch
Patch2:   %{name}-4.4.0.Makefile.in-GIT_DEV.patch
Patch3:   %{name}-4.4.0.loadaverage-kernelinfo.patch
