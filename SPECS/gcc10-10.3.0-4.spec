...
Patch11:  gcc-10.1.0-gcc-config-force-opt-freeware-lib-in-AIX-LIBPATH.patch
...
Patch30: gcc-10.3.0-aix-Add-GCC64-configuration-and-FAT-target-libraries.patch
...
Patch34: gcc-10-aix-Support-GCC64-for-AIX-7.1.patch
...
# %if %{with build_go}
#     for lib in atomic gcc_s stdc++ gomp gfortran go
# %else
