...
Patch27:        mariadb-10.4.8-compile_new_cmake.patch
...
Patch40:        mariadb-10.4.8-plugin_dynamic.patch
# Import symbols for test
Patch41:        mariadb-10.4.6-symbols_test.patch
# Export symbol for dynamic plugins
Patch42:        mariadb-10.4.8-2-plugin_dyn_export.patch
# Test perror
Patch43:        mariadb-10.4.10-errorcode.patch
# Change config files
...
then
  ...
  # TODO: system does not work??
  echo "System PCRE will be used"
  PCRE="auto"
fi
