...
# Fix RTOC_L generation for trampolines
# Backported of CL 228479
Patch1: go-1.14-fix-trampolines-R_TOCL-generation.patch

# Fix linker errors with really huge binaries
Patch2: go-1.14-force-longcall-for-crosscall2.patch
...
# Thus, these lines might be commented or not depending on the version.
...
%changelog
* Mon Aug 10 2020 Clément Chigot <clement.chigot@atos.net> - 1.14.7-1
- Update to version 1.14.7
- Workaround for #40609

* Fri Jul 31 2020 Clément Chigot <clement.chigot@atos.net> - 1.14.6-1
- Update to version 1.14.6
- Backported CL 228479

* Wed Jul 15 2020 Clément Chigot <clement.chigot@atos.net> - 1.14.5 - 1
