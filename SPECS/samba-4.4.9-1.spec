...
%endif
# May be BuildRequires: gnutls-devel >= 3.4.7
...
# Internal or independent TALLOC library/package (2.1.6)
...
%changelog
* Mon Jan 16 2017 Michael Wilson <michael.a.wilson@atos.net> - 4.4.9-1
- Update to version 4.4.9
- Add missing module libpyldb-util.so (required by samba-tool/ldb.so)
