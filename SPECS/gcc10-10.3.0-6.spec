...
%endif
%ifos aix7.3
%global buildhost powerpc-ibm-aix7.3.0.0
%global AIX_requirements \
Requires: AIX-rpm >= 7.3.0.0 \
Requires: AIX-rpm <  7.4.0.0
%endif
...
# Patch to allow GCC to be common across TLs.
# Do not submit
Patch1:   gcc-9.3.0-oslevel.patch

# To be submitted as the last patch, so that go is compiled within AIX
Patch2:  gcc-10.1.0-contrib-config-list-add-go-for-aix.patch
...
Patch181: gcc-8.4.0-aix-apply-socket.h-extern-C-more-narrowly.patch
Patch182: gcc-8.4.0-aix-apply-socket.h-extern-C-even-more-narrowly.patch
...
Patch20: gcc-10.2.0-aix-Fix-_STDC_FORMAT_MACROS-in-inttypes.h.patch

# Add libstdc++ locale support
Patch21: gcc-10.2.0-libstdc-implement-locale-support-for-XPG7.patch

# Fix 64bit inodes with stat
Patch22: gcc-10.3.0-aix-handle-64bit-inodes-for-include-directories.patch

# Fix collect2 with archvies containing text files
Patch23: gcc-8.5.0-aix-collect2-text-files-in-archive.patch

# Fix -mcpu=power10
Patch24: gcc-10.3.0-aix-add-Power10-flag-in-ASM_CPU_SPEC.patch

# Remove -fdump in collect2
# Do not submit for now.
Patch25: gcc-10.3.0-collect2-avoid-passing-fdump-options-when-building-t.patch

# Fix testsuite
# Patch16:  gcc-10.1.0-libatomic-test-correctly-handle-multilib.patch
# Patch17:  gcc-10.1.0-libgomp-test-correctly-handle-multilib.patch
# Patch18:  gcc-10.1.0-libstdc++-test-correctly-handle-multilib.patch

# Backported patches for GCC64.
# The core of GCC64 is working but there is still a few bugs regarding
# compatibility. Thus, GCC64 won't be available for gcc-10.
# However, some patches helps a lot the build as FAT libraries are
# now directly generated. So keep them for GCC32.
Patch30: gcc-10.3.0-aix-Add-GCC64-configuration-and-FAT-target-libraries-v2.patch
Patch31: gcc-10-build-Use-include-instead-of-conditional-include.patch
Patch32: gcc-10-build-Change-conditional-include-and-empty.mk-to-inc.patch
Patch33: gcc-10-aix-FAT-libraries-test-native-compiler-mode-directly.patch
Patch34: gcc-10-aix-Support-GCC64-for-AIX-7.1-v2.patch
Patch35: gcc-10-libgo-add-AIX-FAT-libraries-support.patch
Patch36: gcc-10-libgo-add-FAT-library-support-for-static-libraries-o.patch
Patch37: gcc-10-Support-libsupc-as-a-FAT-library.patch
Patch38: gcc-10-aix-Support-libgfortran-libcaf_single.a-as-a-FAT-lib.patch
Patch39: gcc-10-aix-Use-AR-without-X32_64-to-build-FAT-libraries.patch
Patch40: gcc-10-libgo-cmd-add-maix32-for-aix-ppc.patch
Patch41: gcc-10-aix-add-FAT-library-support-for-libstdc-fs.a.patch
Patch42: gcc-10-aix-remove-libgomp-and-libatomic-archives-before-cre.patch


# Patch for 7.3
Patch50: gcc-10-aix-Add-AIX-7.3-configuration-and-SPDX-License-Ident.patch
Patch51:  gcc-10-gcc-config-force-opt-freeware-lib-in-AIX-LIBPATH-with-7.3.patch

# Ensure TLS programs are linked with pthread
Patch52:  gcc-10-aix-force-reference-to-__tls_get_addr-when-needed.patch

# Remove extern C for system headers
Patch53: gcc-10-aix-SYSTEM_IMPLICIT_EXTERN_C.patch

# Skip some of unsupported tests.
Patch54: gcc-10.3.0-rs6000-Fix-gcc.target-powerpc-testsuite-target-requi.patch

# LIBGO PATCHES

# Remove -fno-section-anchors: No longer needed
# TO SUBMIT
Patch100:   gcc-10.2.0-libgo-configure-remove-fno-section-anchors-on-AIX.patch
...
Patch103:   gcc-10.1.0-libgo-runtime-net-fix-build-errors-on-AIX.patch
Patch104:   gcc-10.1.0-libgo-x-sys-cpu-add-gccgo-support.patch

# Fixes for types pointer duplications
Patch1051:   gcc-10.1.0-libgo-go-runtime-revert-eqtype-for-AIX.patch
Patch1052:   gcc-10.1.0-compiler-call-runtime.eqtype-for-non-interface-type.patch
Patch1053:   gcc-10.2.0-reflect-ensure-uniqueness-of-type-descriptors-on-AIX.patch

# Fix libgo tests.
Patch106:   gcc-10.1.0-libgo-syscall-fix-TestForeground-for-AIX.patch
Patch107:   gcc-9.1.0-libgo-syscall-remove-ptrace-syscall-on-ppc64.patch
Patch108:   gcc-9.1.0-libgo-testsuite-add-mcmodel-large-for-net-http-tests.patch

# Force no inline for runtime.callers as libbacktrace isn't perfect on AIX
Patch109:   gcc-10.1.0-libgo-go-runtime-add-noinline-for-callers.patch

# aix/ppc don't need special handler for its adress space.
Patch110:   gcc-10.1.0-libgo-go-runtime-fix-arenaBaseOffset-for-aix-ppc.patch

# Fix syscall test compilation
Patch111:   gcc-10.1.0-libgo-go-syscall-fix-syscall_unix_test.go-compilation.patch

# Fix gccgoimporter
Patch112:   gcc-10.1.0-libgo-fix-gccgoimporter-for-AIX.patch

# Force %setup to use GNU tar as the extract is currently failing
# with AIX tar.
...
# GCC have been updated to prefere libzstd over zlib.
...
# As gcc is configure with /opt/freeware/bin/sed and bash,
# fixinc.sh in %post will try to call it.
Requires(post): sed, bash
...
Requires: gmp >= 4.3.2, mpfr >= 3.1.0, libmpc >= 1.0.2
Requires: libzstd
%{AIX_requirements}
...
This is GCC Go for AIX. With Go version 1.14.
...
%if %{default_arch} == 64
echo "GCC64 build not yet available"
%endif
...
# Do not remove ppc32 ppc64 & pthread directories since they contain useful stuff for Go
...
# Fix pthread/libgcov.a which isn't multithread
# TODO: patch
(
	cd %{build_dir}/%{buildhost}/pthread/libgcc
	/opt/freeware/bin/install -c -m 644 libgcc.a ../../.././gcc/pthread
	chmod 644 ../../.././gcc/libgcc.a
	ranlib ../../.././gcc/libgcc.a
	/opt/freeware/bin/install -c -m 644 libgcov.a ../../.././gcc/pthread
...
(
	...
	make -k check RUNTESTFLAGS="--target_board=unix'{,${extra_opt},-pthread,${extra_opt}\ -pthread}'" || true
)
%endif
...
%if %{default_arch} == 64
%{gcclibdir}/ppc32/crtcxa*o
%{gcclibdir}/ppc32/crtdbase*.o
%{gcclibdir}/ppc32/libgcc.a
%{gcclibdir}/ppc32/libgcc_eh.a
%{gcclibdir}/ppc32/libgcov.a
%{gcclibdir}/pthread/ppc32/crtcxa*o
%{gcclibdir}/pthread/ppc32/crtdbase*.o
%{gcclibdir}/pthread/ppc32/libgcc.a
%{gcclibdir}/pthread/ppc32/libgcc_eh.a
%{gcclibdir}/pthread/ppc32/libgcov.a
%endif
...
%if %{default_arch} == 64
%{gcclibdir}/ppc32/libgcc_s.a
%{gcclibdir}/ppc32/libatomic.a
%{gcclibdir}/pthread/ppc32/libgcc_s.a
%{gcclibdir}/pthread/ppc32/libatomic.a
%endif
# Full version link
...
%if %{default_arch} == 64
%{gcclibdir}/ppc32/libstdc++.a
%{gcclibdir}/ppc32/libstdc++.a-gdb.py
%{gcclibdir}/pthread/ppc32/libstdc++.a
%{gcclibdir}/pthread/ppc32/libstdc++.a-gdb.py
%endif
...
%if %{default_arch} == 64
%{gcclibdir}/ppc32/libsupc++.a
%{gcclibdir}/ppc32/libstdc++fs.a
%{gcclibdir}/pthread/ppc32/libsupc++.a
%{gcclibdir}/pthread/ppc32/libstdc++fs.a
%endif
%{gcclibdir}/include/c++
...
%if %{default_arch} == 64
%{gcclibdir}/ppc32/libgomp.a
%{gcclibdir}/ppc32/libgomp.spec
%{gcclibdir}/pthread/ppc32/libgomp.a
%{gcclibdir}/pthread/ppc32/libgomp.spec
%endif
%{_infodir}/libgomp*
...
%if %{default_arch} == 64
%{gcclibdir}/ppc32/libgfortran.spec
%{gcclibdir}/ppc32/libcaf_single.a
%{gcclibdir}/pthread/ppc32/libgfortran.spec
%{gcclibdir}/pthread/ppc32/libcaf_single.a
%endif
%dir %{_libexecdir}/gcc
%dir %{_libexecdir}/gcc/%{buildhost}
%dir %{gcclibexecdir}
...
%if %{default_arch} == 64
%{gcclibdir}/ppc32/libgfortran.a
%{gcclibdir}/pthread/ppc32/libgfortran.a
%endif
...
%if %{default_arch} == 64
%{gcclibdir}/ppc32/libobjc.a
%{gcclibdir}/pthread/ppc32/libobjc.a
%endif
...
%if %{default_arch} == 64
%{gcclibdir}/ppc32/libgo.a
%{gcclibdir}/pthread/ppc32/libgo.a
%endif
...
%if %{default_arch} == 64
%{gcclibdir}/ppc32/libgobegin.a
%{gcclibdir}/ppc32/libgolibbegin.a
%{gcclibdir}/pthread/ppc32/libgobegin.a
%{gcclibdir}/pthread/ppc32/libgolibbegin.a
%endif
# .gox files
...
%if %{default_arch} == 64
%{_libdir}/ppc32/go/%{gcc_major}/%{buildhost}
%{_libdir}/pthread/ppc32/go/%{gcc_major}/%{buildhost}
%endif


%changelog
* Mon Oct 11 2021 Clement Chigot <clement.chigot@atos.net> - gcc10-10.3.0-6
- Update zlib dependency for libzstd
- Fix gzip errors in %post

* Thu Oct 07 2021 Clement Chigot <clement.chigot@atos.net> - gcc10-10.3.0-5
- Add aix 7.3 configuration and remove aix 6.1

* Tue Jul 27 2021 Clement Chigot <clement.chigot@atos.net> - gcc10-10.3.0-4
- Add bash as requires(post) for mkheaders

* Wed Jun 09 2021 Clement Chigot <clement.chigot@atos.net> - gcc10-10.3.0-3
- Fix -mcpu=power10
- Remove hardcoding of the assembler and linker taken by gcc.

* Wed May 05 2021 Clement Chigot <clement.chigot@atos.net> - gcc10-10.3.0-2
...
* Tue Mar 09 2021 Clement Chigot <clement.chigot@atos.net> - gcc10-10.3.0-1
- Update to version 10.3.0

* Wed Jan 06 2021 Clement Chigot <clement.chigot@atos.net> - gcc10-10.2.0-1
- Update to version 10.2.0 and create new package gcc10
- Add older libgfortran for backward compatibility
- Add zlib requirements
