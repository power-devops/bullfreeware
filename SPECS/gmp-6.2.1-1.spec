...
export CXX="g++ -maix64"
export LDFLAGS="-L/opt/freeware/lib64 -L/opt/freeware/lib -Wl,-blibpath:/opt/freeware/lib64:/opt/freeware/lib:/usr/lib64:/usr/lib:/lib"
...
%changelog
* Fri Feb 05 2021 Bullfreeware Continous Integration <bullfreeware@atos.net> - 6.2.1-1
- Update to 6.2.1

* Thu Apr 30 2020 Étienne Guesnet <etienne.guesnet.external@atos.net> - 6.2.0-1
- Stop providing link to /usr
- Stop providing .so and .la
- New version
