...
#Source0:        https://storage.googleapis.com/golang/go%{go_version}-%{release}.src.tar.gz
#Source0:        https://dl.google.com/go/go%{go_version}.src.tar.gz
Source0:        go%{go_version}-%{release}.src.tar.gz

# make possible to override default traceback level at build time by setting build tag rpm_crashtraceback
Source1:        aix.go

# Binary files for testing XCOFF.
Source2:	gcc-ppc32-aix-dwarf2-exec
Source3:	gcc-ppc64-aix-dwarf2-exec
...
Patch1:       go-1.11-go-build-runtime-internal-sys-add-GOOS-aix-20180928.patch
Patch2:       go-1.11-cmd-dist-add-AIX-operating-system-20181003.patch
Patch3:       go-1.11-runtime-add-AIX-operating-system-20181004.patch
Patch4:       go-1.11-internal-poll-add-AIX-operating-system-20181004.patch
Patch5:       go-1.11-internal-syscall-add-AIX-operating-system-20181004.patch
Patch6:       go-1.11-syscall-change-solaris-files-to-libc-files-20181010.patch
Patch7:       go-1.11-syscall-add-AIX-operatin-system-20181010.patch
Patch8:       go-1.11-time-add-AIX-operating-system-20181010.patch
Patch9:       go-1.11-crypto-add-AIX-operating-system-20181010.patch
Patch10:      go-1.11-mime-add-AIX-operating-system-20181010.patch
Patch11:      go-1.11-net-add-AIX-operating-system-20181011.patch
Patch12:      go-1.11-os-add-AIX-operating-system-20181011.patch
Patch13:      go-1.11-path-filepath-add-AIX-operating-system-20181011.patch
Patch15:      go-1.11-cmd-internal-xcoff-add-new-debug-package-for-cmd-20181018.patch
Patch16:      go-1.11-runtime-port-assembly-files-for-aix-ppc64-20181019.patch
Patch17:      go-1.11-cmd-internal-xcoff-don-t-use-io-SeekCurrent-for-go1-4-compatibility-20181022.patch
Patch18:      go-1.11-internal-syscall-unix-net-improve-interface-aix-go-20181023.patch
Patch19:      go-1.11-cmd-dist-copy-cmd-internal-xcoff-to-bootstrap-directory-20181023.patch
Patch20:      go-1.11-cmd-link-add-new-loading-package-for-XCOFF-files-20181023.patch
Patch21:      go-1.11-cmd-cgo-add-AIX-operating-system-20181019.patch
Patch22:      go-1.11-cmd-go-add-AIX-operating-system-20181019.patch
Patch23:      go-1.11-net-fix-TestInterfaceMulticastAddrs-for-AIX-20181023.patch
Patch24:      go-1.11-cmd-add-DWARF64-support-for-aix-port-20181024.patch
Patch25:      go-1.11-cmd-link-add-AIX-operating-system-20181024.patch
Patch26:      go-1.11-syscall-fix-TestForeground-for-AIX-20181025.patch
Patch28:      go-1.11-runtime-handle-64bits-addresses-for-AIX-20181127.patch
Patch29:      go-1.11-cmd-compile-fix-nilcheck-for-AIX-20181127.patch
Patch30:      go-1.11-os-fix-tests-for-AIX-20181029.patch
Patch31:      go-1.11-cmd-compile-internal-ssa-fix-TestStmtLines-for-AIX-20181029.patch
Patch33:      go-1.11-runtime-remove-instruction-linked-with-AIX-new-stack-layout-20181029.patch
Patch34:      go-1.11-cmd-allow-build-with-gccgo-on-AIX-20181031.patch
Patch35:      go-1.11-internal-cpu-runtime-Fix-TestPPC64minimalFeatures-fo-20181022.patch
Patch36:      go-1.11-cmd-add-XCOFF-objfile-and-adapt-cmd-nm-tests-20181031.patch
Patch37:      go-1.11-all-fix-tests-for-older-versions-of-AIX-7-2-20181102.patch
Patch38:      go-1.11-all-skip-unsupported-tests-on-AIX-20181102.patch
Patch39:      go-1.11-internal-poll-os-exec-runtime-replace-PollDescriptor-20181102.patch
Patch40:      go-1.11-cmd-compile-internal-gc-update-cgo-import-dynamic-20181106.patch
Patch41:      go-1.11-cmd-link-internal-ld-remove-R_ADDR-relocations-20181127.patch

# x/net
Patch32:      go-1.11-internal-nettest-add-AIX-operating-system-20181022.patch

# Submitted but not yet accepted
Patch27:      go-1.11-cmd-fix-symbols-addressing-for-aix-ppc64-20181019.patch

Source100:      golang-gdbinit

%description
The Go Programming Language source tree v1.11.5 for AIX 7.2 / Power >= 8.
Some features are not yet available: cgo, pprof, race detector.
cmd/link is not completely port too, only the creation of XCOFF executable by the internal linker is available.
...
%prep
# The original $SOURCES/go1.11.src.tar.gz expands as go/* with: %setup -q -n go
...
%define xcoffexecdir src/cmd/internal/xcoff/testdata
cp %{SOURCE2} %{xcoffexecdir}
cp %{SOURCE3} %{xcoffexecdir}
...
ln -sf %{goroot}/bin/go $RPM_BUILD_ROOT%{goroot}/bin/aix_%{gohostarch}/go
ln -sf %{goroot}/bin/gofmt $RPM_BUILD_ROOT%{goroot}/bin/aix_%{gohostarch}/gofmt
...
# NOT on AIX. No alternatives.
#	golang go is at: /opt/freeware/lib/golang/bin/go
...
# Looks like go and gofmt are alreay in go-bin.list
# So, following lines are no more useful
#%{_bindir}/go
#%{_bindir}/gofmt
# Twice ?!
#%{goroot}/bin/go
...
%changelog
* Mon Dec 17 2018 Clément Chigot <clement.chigot@atos.net> - 1.11.5-1
