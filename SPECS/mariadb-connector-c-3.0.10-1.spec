...
Patch7:       mariadb-connector-c-3.0.10-1-libsuffix.patch
...
ln -s /opt/freeware/etc/my.cnf.d /etc/my.cnf.d
ln -s /opt/freeware/etc/my.cnf   /etc/my.cnf
...
%{_includedir}/mysql/*
%exclude %{_includedir}/mysql/server/*
%exclude %{_includedir}/mysql/server
%exclude %{_includedir}/mysql/my_*.h
%exclude %{_includedir}/mysql/mysql_com.h
