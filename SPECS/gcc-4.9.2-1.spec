...
#CC=/opt/hamza/build.gcc.4.8.4/bin/gcc \
...
../%{name}-%{version}/configure \
--with-gmp=/home/gnu/gcc482/ --with-ppl=/home/gnu/gcc482/ --with-mpfr=/home/gnu/gcc482/ --with-mpc=/home/gnu/gcc482/ \
--enable-languages=c,c++,fortran CFLAGS="-O2 -mpowerpc -mno-mfcrf -mtune=power6" CPPFLAGS="-fexceptions" CXXFLAGS="-O2 -mpowerpc -mno-mfcrf -mtune=power6 " \
CPPFLAGS="-I/home/gnu/gcc482/include" LDFLAGS="-L/home/gnu/gcc482/lib" \
--prefix=%{_prefix} \
--mandir=%{_mandir} \
--infodir=%{_infodir} \
...
%changelog
* Thu Apr 02 2015 Hamza Sellami <hamza.sellami@bull.net>     
- Updating GCC to version 4.9.2 on AIX 7.1 
