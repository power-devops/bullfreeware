...
# Some tests fail with database corruption
%define connect   NO
# wsrep has symbol error
%define wsrep     NO
...
## Use berok even on debug
Patch2:  mariadb-10.6.5-heap_symbol.patch
...
%changelog
* Wed Feb 02 2022 Etienne Guesnet <etienne.guesnet@atos.net> - 10.6.5-2
- Use default value for most of the plugin
- Add patch for heap unit test
