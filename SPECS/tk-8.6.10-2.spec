...
# From tk-8.5.19-1 :
Source5:	libtk8.5.so-aix32
Source6:	libtk8.5.so-aix64
...
export LDFLAGS32="-L/opt/freeware/lib -Wl,-blibpath:/opt/freeware/lib:/usr/lib:/lib -Wl,-bmaxdata:0x80000000"

# export LDFLAGS64="-L/opt/freeware/lib"
export LDFLAGS64="-L/opt/freeware/lib64 -L/opt/freeware/lib -Wl,-blibpath:/opt/freeware/lib64:/opt/freeware/lib:/usr/lib:/lib"
...
gmake %{?_smp_mflags} TK_LIBRARY=%{_datadir}/%{name}%{majorver} -j16
...
(LIBPATH=.:/opt/freeware/lib64:/opt/freeware/lib:/usr/lib:/lib gmake -k test || true)
