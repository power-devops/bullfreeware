...
Source1: ftp://ftp.gnu.org/gnu/make/%{name}-%{version}.tar.gz.sig
...
%prep
%setup -q
# %patch0 -p1 -b %{name}-%{version}-aixrealpath.patch
...
export CC=${CC64}
export LDFLAGS=" -Wl,-blibpath:/opt/freeware/lib64:/opt/freeware/lib:/usr/lib -Wl,-bnoipath"
build_make

cd ../32bit
export OBJECT_MODE=32
export CC=${CC32}
export LDFLAGS=" -Wl,-bmaxdata:0x80000000 -Wl,-blibpath:/opt/freeware/lib:/usr/lib -Wl,-bnoipath"
build_make
...
%changelog
* Wed Oct 28 2020 Bullfreeware Continuous Integration <bullfreeware@atos.net> - 4.3-3
- Rebuild 4.3

* Wed Oct 28 2020 Étienne Guesnet <etienne.guesnet@atos.net> - 4.3-2
- Use AIX make

* Tue Feb 25 2020 Étienne Guesnet <etienne.guesnet.external@atos.net> - 4.3-1
- Use opensource perl
- No more provides link to /usr/bin
- Correct internal libpath
- Default version is 64bit

* Fri Jun 21 2019 Clement Chigot <clement.chigot@atos.net> - 4.2.1-4
- remove guile dependency
