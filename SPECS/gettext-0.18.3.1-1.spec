...
cp ./gettext-tools/gnulib-lib/.libs/libgettextlib-0.18.3.so .
cp ./gettext-tools/src/.libs/libgettextsrc-0.18.3.so .

make distclean

# now build the 32-bit version
CFLAGS="-qlanglv=extc89" \
CPPFLAGS=" -I/opt/freeware/include" \
./configure \
    --prefix=%{_prefix} \
    --infodir=%{_infodir} \
...
${AR} -q ./gettext-tools/gnulib-lib/.libs/libgettextlib-0.18.3.a ./libgettextlib-0.18.3.so
${AR} -q ./gettext-tools/src/.libs/libgettextsrc-0.18.3.a ./libgettextsrc-0.18.3.so
...
cp -p -f ./gettext-tools/gnulib-lib/.libs/libgettextlib-0.18.3.a ${RPM_BUILD_ROOT}%{_libdir}
cp -p -f ./gettext-tools/src/.libs/libgettextsrc-0.18.3.a ${RPM_BUILD_ROOT}%{_libdir}
