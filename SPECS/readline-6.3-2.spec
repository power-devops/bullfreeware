...
Patch1: readline63-001.patch
Patch2: readline63-002.patch
Patch3: readline63-003.patch
Patch4: readline63-004.patch
Patch5: readline63-005.patch
Patch6: readline63-006.patch
Patch7: readline63-007.patch
Patch8: readline63-008.patch
...
/usr/bin/nm -X64 shlib/libreadline.so.6 | grep bcopy
...
# Check the bcopy issue
/usr/bin/nm -X32 shlib/libreadline.so.6 | grep bcopy
...
%changelog
* Wed Jul 03 2018 Tony Reix <tony.reix@atos.net> - 6.3-2
- Use patches 7 & 8
- Move to GCC
