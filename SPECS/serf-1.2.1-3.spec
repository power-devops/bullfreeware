...
export CC="/usr/vac/bin/xlc_r -qcpluscmt -q64"
...
export CC="/usr/vac/bin/xlc_r -qcpluscmt -q32"
...
cd 64bit
export OBJECT_MODE=64
export CFLAGS="-q64 $CFLAGS"
gmake DESTDIR=${RPM_BUILD_ROOT} install

cd ../32bit
export OBJECT_MODE=32
export CFLAGS="-q32 $CFLAGSÃ"
gmake DESTDIR=${RPM_BUILD_ROOT} install
...
%changelog
* Tue Feb 07 2017 Tony Reix <tony.reix@bull.net>  1.2.1-3
- Fix -q64 & -q32
