...
Patch0:		%{name}-1.2.11-aix-mandir-2.patch
Patch1:		%{name}-1.2.11-aix-configure-gcc.patch
...
%changelog
* Tue Sep 07 2021 Clément Chigot <clement.chigot@atos.net> - 1.2.11-6
- Remove .pc file
- Remove /usr links

* Tue Oct 13 2020 Bullfreeware Continuous Integration <bullfreeware@atos.net> - 1.2.11-5
- Update to 1.2.11
