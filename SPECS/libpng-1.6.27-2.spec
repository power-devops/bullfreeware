...
# If building on a system installed with earlier than 1.6.27, the new function
# png_image_write_to_memory() in ./pngwrite.c called in
# ./contrib/libtests/pngstest.c forces archive of new libpng16.so.16
# in library /opt/freeware/lib/libpng16.a    - build issue not resolved
...
* Tue Jan 02 2017 Michael Wilson <Michael.A.Wilson@atos.net> - 1.6.27-1
