...
# Not sure this Fedora patch applies to AIX
...
#BuildRequires: libXpm-devel      - Not available on AIX
...
%patch4 -p1 -b .buffoverflow
%patch5 -p1 -b .doublefree
%patch6 -p1 -b .nullptr
...
chmod 644 ./tests/jpeg/jpeg_ptr_double_free.c.doublefree
chmod 644 ./tests/gdimageclone/style.c.nullptr
